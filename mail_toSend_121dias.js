...
// var body_mail = Procedimiento7_MX2020.html
...
'<title>Tu cabello dice más de lo que piensas</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE CITA DE 4 MESES O AL DÍA 121 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3982644&c=3559763&h=4dce5c90fb322c971c4b&mv=k3fa84nc&_xt=.html&fcts=20191125190957&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982639&c=3559763&h=d22b23df9d92477c766c&fcts=20191125190518&whence=" style="display: block;" width="100%" border="0" alt="Recuperar tu cabello te abre las puertas a un mundo de posiblidades" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Tener cabello donde antes había alopecia dice más de lo que piensas. </div></td>'+
'              </tr>'+
'				'+
...
'				  '+
'				  No sólo se trata de mejorar tu apariencia, de cambiar tu percepción y la del mundo. También es sinónimo de juventud, vitalidad y buena salud. Es tomar el control y frenar el paso del tiempo.'+
'				  '+
'				  </b></div></td></tr>'+
'				'+
...
'					RECUERDA AGENDAR TU CITA DE REVISIÓN DE 5 MESES<br>'+
'					Y PIDE TU DIAGNÓSTICO FACIAL O CORPORAL DE CORTESÍA'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7092', body_mail); // Disparo mailing 121D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Tu cabello dice más de lo que piensas', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 121D to: ', correo);
                      }
                    }
                    count++;
                });
