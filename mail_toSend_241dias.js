...
// var body_mail = Procedimiento11_MX2020.html
...
'<title> ¿Pensando en un segundo procedimiento?</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE 8 MESES O AL DÍA 241 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3982773&c=3559763&h=52ff9fe530b8a222bdc3&mv=k3fb0xoo&_xt=.html&fcts=20191125193221&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982772&c=3559763&h=ecf93a99e4f5f919b6fe&fcts=20191127100144&whence=" style="display: block;" width="100%" border="0" alt="¿Has pensado en realizar un segundo procedimiento?" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> En estos meses ya has visto algunos resultados de tus implantes capilares.   </div></td>'+
'              </tr>'+
'				'+
...
'				  '+
'				 Aún no son los definitivos, pues el cabello sigue creciendo, pero ya puedes ver tu imagen restaurada. '+
'				  '+
'				  </div></td></tr>'+
'				'+
'				<tr><td height="15" style="font-size: 15px; line-height: 15px;"></td></tr>'+
...
'					<b>¿Por qué realizar un segundo procedimiento?</b>'+
'					<br><br>'+
'					Realizar un solo procedimiento puede ser suficiente para cumplir tus expectativas de recuperar cabello en las zonas afectadas por la alopecia.'+
'					<br><br>'+
'					Sin embargo, en ocasiones hay pacientes que desean aumentar la densidad de cabello en la zona tratada. '+
'					<br><br>'+
'					Otra situación recurrente es que, con el paso del tiempo el cabello nativo (no el implantado) puede continuar cayéndose, lo que puede dejar despobladas otras zonas no tratadas.'+
'					<br><br>'+
'					También sucede que, luego de haber recuperado la densidad capilar en la cabeza, algunos pacientes consideran la posibilidad de incrementar la densidad en barba o ceja.'+
'					<br><br>'+
'					Por ello es importante consultar con el médico la viabilidad de un segundo procedimiento.'+
'					</td>'+
'                  </tr>'+
...
'                  </tr>'+
'					'+
'				<table border="0" width="450" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">'+
...
'					AGENDA TU CITA DE REVISIÓN DE 9 MESES <br>'+
'					Y PIDE A TU MÉDICO UNA SEGUNDA VALORACIÓN. '+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7096', body_mail); // Disparo mailing 241D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'¿Pensando en un segundo procedimiento?', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 241D to: ', correo);
                      }
                    }
                    count++;
                });
