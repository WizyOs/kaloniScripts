...
// var body_mail = Procedimiento13_MX2020.html
...
'<title>Vitaminas para tu cabello</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE 10 MESES O AL DÍA 301 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3982879&c=3559763&h=3280860e8f86ec37f7c8&mv=k3fbxwew&_xt=.html&fcts=20191125195759&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982878&c=3559763&h=f3df28a5a45c34966407&fcts=20191125195302&whence=" style="display: block;" width="100%" border="0" alt="Estimula el crecimiento de tu cabello" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> La nutrición que tu cabello necesita.  </div></td>'+
'              </tr>'+
'				'+
...
'				  '+
'				A través de un tratamiento subcutáneo que se aplica en el cuero cabelludo, se puede estimular la actividad de los folículos pilosos.'+
'				  '+
'				  </div></td></tr>'+
'				'+
...
'					La bioestimulación con Plasma Rico en Plaquetas (PRP) o el aporte vitamínico con factores de crecimiento mediante mesoterapia, te ayudarán a fortalecer el cabello y generar los nutrientes necesarios para hacerlo más resistente a factores como el sol, estrés, contaminación, químicos y otros.'+
'					<br><br>	'+
'					Pregunta a tu médico cuál es el mejor momento para aplicar una mesoterapia capilar.'+
'					</td>'+
'                  </tr>'+
...
'					AGENDA TU CITA DE REVISIÓN DE 11 MESES'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7098', body_mail); // Disparo mailing 301D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Vitaminas para tu cabello', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 301D to: ', correo);
                      }
                    }
                    count++;
                });
