...
// var body_mail = Procedimiento15_MX2020.html
...
'<title>Mantén una rutina de cuidado capilar</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE 12 MESES O AL DÍA 361 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3983080&c=3559763&h=5f8c3a14016dc1a2a75f&mv=k3fc3sls&_xt=.html&fcts=20191125200234&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3983081&c=3559763&h=271c8e358533916a2958&fcts=20191125200211&whence=" style="display: block;" width="100%" border="0" alt="La Importancia de una rutina de cuidado capilar" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Mantener la salud de tu cabello no es algo pasajero. </div></td>'+
'              </tr>'+
'				'+
'				<tr><td height="5" style="font-size: 5px; line-height: 5px;"></td></tr>'+
'				'+
'			  <tr><td><div style="color: #456cb3;font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 500;line-height: 23px;">Ya recuperaste densidad capilar donde antes había signos de alopecia. Ahora es importante que cuides no sólo tus implantes, sino todo tu cabello. </div></td></tr>'+
'				'+
...
'					Para ello debes usar un shampoo especial, dermatológico, orientado por especialistas. De lo contrario, el cabello nativo podría debilitarse y caer debido a los efectos androgenéticos. En consecuencia, los resultados positivos del microinjerto pueden verse antiestéticos.'+
'					</td>'+
'                  </tr>'+
'                </table>'+
'		'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;">Usa el shampoo control caída del Kit Kaloni Complete®.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Procura lavar el cabello con agua templada.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="20" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Corta las puntas tres o cuatro veces al año.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                  <tr>'+
'                    <td height="40" style="color: #333333; font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 25px;"> '+
'					En tu próxima cita de revisión pregunta a tu médico la frecuencia y el método de empleo del shampoo dermatológico para tu nueva rutina de cuidado. '+
'					</td>'+
'                  </tr>'+
'					<tr>'+
'                    <td height="20" style="font-size: 20px; line-height: 20px;"> </td>'+
...
'                  </tr>'+
'					'+
'				<table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">	'+
'                  <tr><td height="5" style="font-size: 5px; line-height: 5px;"> </td>'+
...
'					AGENDA TU CITA DE REVISIÓN DE 13 MESES'+
'					</td><td height="5" style="font-size: 5px; line-height: 5px;"> </td>'+
'                  </tr>'+
'				</table>'+
'					'+
'                </table>'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7101', body_mail); // Disparo mailing 361D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Mantén una rutina de cuidado capilar', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 361D to: ', correo);
                      }
                    }
                    count++;
                });
