...
function(record,search,format) {
    ...
    function _post(context) {
      ...
      if (obj.hasOwnProperty("param1"))
      {
         ...
         if (valparam === 'agendamensualsucursal')
         {
            val1 = _get_agendamensualsucursal();
           	//log.audit('val1: ', val1);
         }
         ...
         else if (valparam === 'efectivamensualsucursal'){
            val1 = _get_efectivamensualsucursal();
           	//log.audit('val1: ', val1);
         }
		 else if (valparam === 'efectivamensualcampana'){
            val1 = _get_efectivamensualcampa();
           	//log.audit('val1: ', val1);
         }
       	 else if (valparam === 'leadmensualsucursal'){
            val1 = _get_leadmensualsucursal();
           	//log.audit('val1: ', val1);
         }
         else if (valparam === 'leadmensualcampana'){
            val1 = _get_leadmensualcampa();
           	//log.audit('val1: ', val1);
         }
      }
  	...
  	function _get_agendamensualsucursal(){
      	var count = 0;
        var ejecutivosArray = [];
        var counts = {};
