...
NetsuiteToolkit.setFieldValue = function(record, field_name, value) {
  if (field_name === 'startdate') {
    record.setDateTimeValue('startDate', nlapiDateToString(new Date(value), 'datetimetz'), 5);
  } else if (field_name === 'enddate') {
      record.setDateTimeValue('endDate', nlapiDateToString(new Date(value), 'datetimetz'), 5);
  } else {
