    ...
    function onRequest(context)
    {
    	try
        {
			...
			if(invoiceId != "" && invoiceId != null)
            {
              ...
              var locationText = invoice.getText({fieldId: 'location'});
              ...
              var entity = invoice.getValue({fieldId: 'entity'}); // cliente
              ...
              var fileFolios = file.load({id:txtFolios});
              var fileOrigen = {id:fileFolios.id, name:fileFolios.name, folder:fileFolios.folder, fileType:fileFolios.fileType, contents:fileFolios.getContents()};
              ...
              if(entity != null && entity != "" && tranid != null && tranid != "" && folio != null && folio != "")
              {
                ...
                var entityid = customerRec.getText({fieldId: 'entityid'}); // HG
                ...
                if(defaultaddress != "" && defaultaddress != null && altname != "" && altname != null && entityid != "" && entityid != null && footerPDF != null && footerPDF != "" && dataCompanyPDF != null && dataCompanyPDF != "") // defaultaddress != "" && defaultaddress != null &&
                {
                  ...
                  xml += '<p></p>';
                  xml += "<table style=\"width:100%;\"><tr><td color=\"black\">Bitte begleichen Sie den Rechnungsbetrag 10 Tage vor dem geplanten OP-Tag.</td></tr></table>";
                  ...
                  if(position == -1)
                  {
                    fileOrigen.contents = fileOrigen.contents.replace(folio, folio+'|'+tranid+'|ok');
                  	var newFile = file.create({name:fileOrigen.name, fileType:fileOrigen.fileType, contents:fileOrigen.contents, encoding:file.Encoding.UTF8, folder:fileOrigen.folder, isOnline:false});
              	  	newFile.save();
                  }
                  return;
                  /*
