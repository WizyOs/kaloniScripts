...
// var body_mail = Procedimiento8_MX2020.html
...
'<title>Tu cabello está casi listo</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE CITA DE 5 MESES O AL DÍA 151 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3982658&c=3559763&h=22e44d559dd52fd39863&mv=k3facueg&_xt=.html&fcts=20191125191337&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982647&c=3559763&h=aa2e50535a1eb1d0162b&fcts=20191125191143&whence=" style="display: block;" width="100%" border="0" alt="Deja salir lo mejor de ti" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Porque un verdadero cambio no puede pasar desapercibido. </div></td>'+
'              </tr>'+
'				'+
...
'				  '+
'				  ¿Cuántas personas comienzan a preguntar qué te has hecho para verte y sentirte mejor?'+
'				  '+
'				  </b></div></td></tr>'+
'				'+
...
'					En Kaloni agradecemos tu confianza y te recordamos que cuentas con el respaldo médico de nuestros especialistas.'+
'					<br><br>	'+
'					Ahora que ya empiezas a ver el inicio de tus resultados, es un buen momento para mostrar al mundo el camino hacia tu mejor versión. Compártenos tu opinión y tu experiencia sobre cómo has vivido este proceso de recuperar tu cabello.<span style="color: #456CB3; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 800;"><a href="https://bit.ly/2W4pOO7" style="color: #456CB3;border-style: none !important; border: 0 !important;text-decoration: none;"> Haz clic aquí</a></span>'+
'					</td>'+
'                  </tr>'+
'                </table>'+
''+
...
'					NO OLVIDES AGENDAR TU CITA DE REVISIÓN DE 6 MESES'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7093', body_mail); // Disparo mailing 151D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Tu cabello está casi listo', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 151D to: ', correo);
                      }
                    }
                    count++;
                });
