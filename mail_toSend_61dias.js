...
// var body_mail = Procedimiento5_MX2020.html
...
'<title>Recordatorio cita de revisión de 3 meses</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982509&c=3559763&h=672fba4dfdf45caf7490&fcts=20191125185638&whence=" style="display: block;" width="100%" border="0" alt="Has tomado la decisión correcta, sólo ten paciencia" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> ¡Ánimo! Viene la etapa más compleja en este camino rumbo a tu objetivo para recuperar tu cabello. </div></td>'+
'              </tr>'+
'				'+
'				<tr><td height="5" style="font-size: 5px; line-height: 5px;"></td></tr>'+
'				'+
'			  <tr><td><div style="color: #456cb3;font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 500;line-height: 23px"> Han pasado ya más de 6 semanas desde que realizaste tu procedimiento y seguramente ya empiezas a notar algunos cambios importantes. </b></div></td></tr>'+
'				'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Notarás despoblada la zona injertada (fase de recambio). </div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> La irritación y zonas rojas ya habrán desaparecido.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="20" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Pronto comenzarán a crecer poco a poco los nuevos cabellos.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'					Conoce más sobre los primeros signos de evolución del implante y los cuidados que debes tener en <a href="https://kaloni.mx/blog/injerto-capilar/injerto-capilar-3-meses-los-primeros-signos-de-evolucion/" style="font-weight: 800;">estos primeros 3 meses.</a>'+
'					<br><br>'+
'					Como puedes leer, la fase de recambio es completamente normal, de todas formas es importante que acudas a tu cita de revisión mensual para darte seguimiento y así asegurar los mejores resultados. '+
'					</td>'+
'                  </tr>'+
'					<tr>'+
'                    <td height="20" style="font-size: 20px; line-height: 20px;"> </td>'+
...
'					AGENDA TU CITA DE REVISIÓN DE 3 MESES'+
'					</td>'+
'                  </tr>'+
'				</table>'+
'					'+
...
'                        '+
'                        <div  class="container590 container590-center"style="line-height: 25px;text-align: left;width: 280px;"> Este correo te será enviado al dejar tus datos en nuestra página web, K- Center o página de Facebook. </div>'+
'                    </tr>'+
'                  </table>'+
'                  <table border="0" width="2" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">'+
'                    <tr>'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7090', body_mail); // Disparo mailing 61D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Recordatorio cita de revisión de 3 meses', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 61D to: ', correo);
                      }
                    }
                    count++;
                });
