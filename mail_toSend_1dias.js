...
// var body_mail = Procedimiento2_MX2020.html
...
'<title>¿Cómo retirar las costras del microinjerto?</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE LAVADO (24 HORAS) ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3982308&c=3559763&h=13b88abe21ecc82e174e&mv=k3f8ph20&_xt=.html&fcts=20191125182727&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982197&c=3559763&h=3941a0341feb72de19f6&fcts=20191125182423&whence=" style="display: block;" width="100%" border="0" alt="Porque nos importa tu tranquilidad y confianza" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> En los próximos 10 días tu cuero cabelludo comenzará a sanar del proceso de microinjerto. </div></td>'+
'              </tr>'+
'				'+
'				<tr><td height="5" style="font-size: 5px; line-height: 5px;"></td></tr>'+
'				'+
'			  <tr><td><div style="color: #456cb3;font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 500;line-height: 23px;"> Notarás que se empiezan a formar algunas costras tanto en la zona donadora como en la zona injertada. Sentirás algo de ardor y comezón. <b>Es un proceso normal.</b></div></td></tr>'+
'				'+
'				<tr><td height="15" style="font-size: 15px; line-height: 15px;"></td></tr>'+
'				'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Es importante que mantengas hidratadas las costras. Usa el agua glaciar. </div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Por ningún motivo frotes ni rasques las zonas tratadas.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="20" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Puedes usar una gorra o sombrero sobrepuesto para ocultar las costras.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                  </tr>'+
'                  <tr>'+
'                    <td height="40" style="color: #333333; font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 40px;"> <a href="https://kaloni.mx/blog/injerto-capilar/implante-capilar-dia-a-dia-1-10/" style="font-weight: 800;">Encuentra aquí más información</a> sobre los cuidados que debes mantener en los próximos 10 días.'+
'					<br>'+
'					<span style="color: #456CB3; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 800;">Recuerda agendar tu cita de 10 días para retirar las costras de forma segura en la clínica.</span>'+
'					<br>'+
...
'</body>'+
'</html>';
            var result = get_saved_search('customsearch7088', body_mail); // Disparo mailing 1D
                ...
                myPage.data.forEach(function(result){
                    ...
                    if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'¿Cómo retirar las costras del microinjerto?', body:body_m}); // 103204 198528 , cc: ccRecip
