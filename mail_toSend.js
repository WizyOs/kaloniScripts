...
define(["N/ui/serverWidget", "N/crypto", "N/https", "N/runtime", "N/encode", "N/url", 'N/email', 'N/log', 'N/search'],
    function (ui, crypto, https, runtime, encode, urlMod, email, log, search) {
        function execute(context) {

// var body_mail = Procedimiento1_MX2020.html
...
'</body>'+
'</html>';
            var result = get_saved_search('customsearch7087', body_mail); // Disparo mailing 24H
          ...
          try
          {
            ...
            myPagedData.pageRanges.forEach(function(pageRange){
                ...
                myPage.data.forEach(function(result){
                    ...
                    email.send({author: 103204, recipients:'acolin@kaloni.com', subject:'Recordatorio cita para lavado de injerto (Disparo mailing 24H)', body:body_m});
            		log.debug('Disparo mailing 24H to: ', correo);
                    count++;
                });
            });
          	return true;
