   ...
   function beforeLoad(context) {
      try {
         if (context.type == "view") // context.type == "edit" ||
         {
            ...
            var url = "https://api.messagemedia.com/v2/messages";
            ...
            if (recordId != "" && recordId != null) {
               ...
               if (company != "" && company != null) {
                  ...
                  if (subsidiary == "6" && mobilephone != "" && mobilephone != null) {
                     ...
                     if (prefijoEvento == "12" && detalleCancelacion == "3" && newValPhone.length == 10) {
                        ...
                        if (mm_SMS_Val_NSP == "" || mm_SMS_Val_NSP == null) // && mm_SMS_Val_NSP.length <= 3
                        {
                           ...
                           var msgContent = "Lamentamos que no haya acudido a su cita de valoración. Puede reagendar al (55) 5022 1056";
                           var bodyRequest = '{"messages":[{"content":"' + msgContent + '", "destination_number":"' + newValPhone + '", "format":"SMS"}]}';
