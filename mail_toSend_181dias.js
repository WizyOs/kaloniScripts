...
// var body_mail = Procedimiento9_MX2020.html
...
'<title>Cada detalle cuenta</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE 6 MESES O AL DÍA 181 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3982763&c=3559763&h=903092d3a56329f4c87f&mv=k3fal15k&_xt=.html&fcts=20191125191959&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982762&c=3559763&h=44e0e20fb0e525ffd822&fcts=20191125191830&whence=" style="display: block;" width="100%" border="0" alt="Conoce las tendencias en cuidado y bienestar masculino" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> ¿Has oído hablar de las tendencias wellness y men’s grooming? </div></td>'+
'              </tr>'+
'				'+
'				<tr><td height="5" style="font-size: 5px; line-height: 5px;"></td></tr>'+
'				'+
'			  <tr><td><div style="color: #456cb3;font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 500;line-height: 23px;">'+
'				  '+
'				  En la actualidad, los hombres quieren verse y sentirse bien de manera integral, no sólo física, sino también espiritual y emocionalmente. Los hombres optan por cuidarse más. A esta tendencia se le conoce como Wellness: bienestar integral.'+
'				  '+
'				  </b></div></td></tr>'+
'				'+
...
'					Ahora que estás empezando a notar un cambio en la densidad de tu cabello, es un buen momento para cuidar otros aspectos de tu imagen.'+
'					<br><br>'+
'					Nuestra experiencia en el cuidado del hombre en Kaloni nos ha llevado a crear <span style="color: #456CB3; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 800;">INFINITY System</span>, un sistema de diagnóstico integral, a través del cual, médicos de distintas especialidades analizan el historial clínico de cada paciente e identifican las áreas de oportunidad en el cuerpo del hombre, tales como: reducir arrugas, flacidez e imperfecciones de la piel; destruir la grasa corporal, y mejorar el desempeño físico y mental para vencer los retos del día a día.'+
'					</td>'+
'                  </tr>'+
...
'                  </tr>'+
'					'+
'				<table border="0" width="440" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">'+
...
'					AGENDA TU CITA DE REVISIÓN CAPILAR DE 7 MESES <br>'+
'					Y PIDE TU DIAGNÓSTICO INTEGRAL DE CORTESÍA'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7094', body_mail); // Disparo mailing 181D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Cada detalle cuenta', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 181D to: ', correo);
                      }
                    }
                    count++;
                });
