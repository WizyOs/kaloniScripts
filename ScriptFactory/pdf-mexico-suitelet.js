function portletName(request, response){
	...
	var water = "https://system.na2.netsuite.com/core/media/media.nl?id=774338&c=3559763&h=9d682b587932a872dc76";
   var recId = request.getParameter('id');
   var record = nlapiLoadRecord('Customer', recId);
  var name = record.getFieldLabel('entityid');
...
strName+=cadena2;
 ...
 strName +="</td>";
  ...
  strName +="<td>Extrajo:";
  strName +="</td>";
  strName +="<td><b>Doctor Jaun Lopez  de Leon</b>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<td>Implantó:";
  strName +="</td>";
   strName +="<td><b>Doctor Juan Lopez  de Leon</b>";
  strName +="</td>";
  strName +="</tr>";
  strName +="</table>";
...
try{
 ...
 /*   var folder3 = nlapiCreateRecord('folder');
  ...
  var FOLD24H = nlapiCreateRecord('folder');
    ...
    FOLD6MESES.setFieldValue('name','R6MESES');
