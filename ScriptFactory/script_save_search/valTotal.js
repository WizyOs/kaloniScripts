function valTotal(){
    var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch2045');
for(var z=0; z<revresults.length; z++) {
   ...
   location.setFieldValue('custrecord8', count);//valoraciones agendades
   ...
   location.setFieldValue('custrecord8', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
