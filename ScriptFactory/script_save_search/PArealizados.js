function parealizados(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1877');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord11', count);//PRO.REALIZADOS
   ...
   location.setFieldValue('custrecord11', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
