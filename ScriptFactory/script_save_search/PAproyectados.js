function paproyectados(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1876');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord19', count);//PRO.PROYECTADOS
   ...
   location.setFieldValue('custrecord19', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
