function leadssuc(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('Customer','customsearch1881');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord31', count);//PROYECTADOS DIC
   ...
   location.setFieldValue('custrecord31', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
