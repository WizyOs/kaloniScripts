function valempkcenterefec(){
    ...
    var revresults = nlapiSearchRecord('calendarevent','customsearch3003');
	for(var z in revresults ) {
      ...
      if(kcenter=='Andrea Martinez Avila'){
       ...
       campo15 = nlapiLoadRecord('employee', '562921');//numero_empleado
       campo15.setFieldValue('custentity305', count);
       nlapiSubmitRecord(campo15, true);
       continue;
    }
       if(kcenter=='Jose Manuel Borja Castro'){
       campo16 = nlapiLoadRecord('employee', '598011');//numero_empleado
