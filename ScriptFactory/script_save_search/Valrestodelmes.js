function valResMes(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1884');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord33', count);//candidatos SI
   ...
   location.setFieldValue('custrecord33', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
