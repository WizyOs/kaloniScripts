function candidatosSI(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1238');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord23', count);//candidatos SI
   ...
   location.setFieldValue('custrecord23', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
