function paprogramados(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1878');
for(var z in revresults) {
   ...
   location.setFieldValue('custrecord18', count);//PRO.PROGRAMADOS
   ...
   location.setFieldValue('custrecord18', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
