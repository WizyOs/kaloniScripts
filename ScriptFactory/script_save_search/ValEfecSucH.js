function valESH(){
    var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1978');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord7', count);//candidatos SI
   ...
   location.setFieldValue('custrecord7', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
  ...
  // script val efec suc insitum h    customscript577
  var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1976');
for(var z in revresults ) {
   ...
   if(sucursal=='Santa Fe KHG'){
   location = nlapiLoadRecord('location',21);//santa fe
   location.setFieldValue('custrecord29', count);//candidatos SI
   nlapiSubmitRecord(location, true);
     continue;
   }
   ...
   if(sucursal=='Altavista KHG'){
   location = nlapiLoadRecord('location',22);//altavista
   location.setFieldValue('custrecord29', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
