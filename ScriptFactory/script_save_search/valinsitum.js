function valinsitum(){
    var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch2047');
  ...
  for(var z=0; z<revresults.length; z++) {
   ...
   location.setFieldValue('custrecord30', count);//valoraciones agendades
   ...
   location.setFieldValue('custrecord30', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
