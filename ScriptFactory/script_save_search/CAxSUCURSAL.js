function caxsucursal(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('transaction','customsearch1874');
for(var z in revresults) {
   ...
   location.setFieldValue('custrecord10', count);//CIERRES ANTICIPO
   ...
   location.setFieldValue('custrecord10', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
