function candidatosSin(){
    var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1888');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord25', count);//candidatos SI
   ...
   location.setFieldValue('custrecord25', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
