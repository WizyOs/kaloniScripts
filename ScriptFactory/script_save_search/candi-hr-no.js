function candidatosNo(){
   	var count='';
    var location='';
    var revresults = nlapiSearchRecord ('calendarevent','customsearch1882');
for(var z in revresults ) {
   ...
   location.setFieldValue('custrecord24', count);//candidatos NO
   ...
   location.setFieldValue('custrecord24', count);
   nlapiSubmitRecord(location, true);
    continue;
   }
