  ...
  function(widget, url, https, file, record, xml, runtime, search) {
    function onRequest(context) {
      ...
      var arr_nameFolderReview = {
        0:{"index":1,"text":"R24HORAS"},
        1:{"index":2,"text":"R10DIAS"},
        2:{"index":3,"text":"R1MES"},
        3:{"index":4,"text":"R2MESES"},
        4:{"index":5,"text":"R3MESES"},
        5:{"index":6,"text":"R4MESES"},
        6:{"index":7,"text":"R5MESES"},
        7:{"index":8,"text":"R6MESES"},
        8:{"index":9,"text":"R7MESES"},
        9:{"index":10,"text":"R8MESES"},
        10:{"index":11,"text":"R9MESES"},
        11:{"index":12,"text":"R10MESES"},
        12:{"index":13,"text":"R11MESES"},
        13:{"index":14,"text":"R12MESES"},
        14:{"index":15,"text":"R13MESES"},
        15:{"index":16,"text":"R14MESES"}
      }
      arr_nameFolderReview = [
        "R24HORAS",
        "R10DIAS",
        "R1MES",
        "R2MESES",
      ...
      if (context.request.method === 'GET') {
        ...
        session = context.request.parameters.session;
        ...
        var idCustomerText = objRecord.getText({
          fieldId: "entityid"
        });
        var nameFolderCustomer = idCustomerText + "_FOLDER";
        var formulario = widget.createForm({
        ...
        if (review != undefined) {
          try {
            ...
            search.create({
              ...
              idReviewFolder = result.getValue({
                name: "internalid"
              });
              nameReviewFolder = result.getValue({
                name: "name"
              });
            });
            ...
            for (var kt in searchResult) {
              internalId = searchResult[kt].getValue({
                name: 'internalid'
              });
              name = searchResult[kt].getValue({
                name: 'name'
              });
        ...
        if (customform == 135) {
          field_image_1 = formulario.addField({
            id: 'custpage_image_1',
            type: 'file',
            label: 'IMAGEN VALORACIÓN 1'
          });
          field_image_2 = formulario.addField({
            id: 'custpage_image_2',
            type: 'file',
            label: 'IMAGEN VALORACIÓN 2'
          });
          field_image_3 = formulario.addField({
            id: 'custpage_image_3',
            type: 'file',
            label: 'IMAGEN VALORACIÓN 3'
          });
          field_image_4 = formulario.addField({
            id: 'custpage_image_4',
            type: 'file',
            label: 'IMAGEN VALORACIÓN 4'
          });
          field_image_5 = formulario.addField({
            id: 'custpage_image_5',
            type: 'file',
            label: 'ROSTRO 1'
          });
          field_image_6 = formulario.addField({
            id: 'custpage_image_6',
            type: 'file',
            label: 'ROSTRO 2'
          });
          field_image_7 = formulario.addField({
            id: 'custpage_image_7',
            type: 'file',
            label: 'IMAGEN 1 MICROCAMARA'
          });
          field_image_8 = formulario.addField({
            id: 'custpage_image_8',
            type: 'file',
            label: 'IMAGEN 2 MICROCAMARA'
          });
          field_image_9 = formulario.addField({
            id: 'custpage_image_9',
            type: 'file',
            label: 'IMAGEN 3 MICROCAMARA'
          });
          field_image_10 = formulario.addField({
            id: 'custpage_image_10',
            type: 'file',
            label: 'IMAGEN 4 MICROCAMARA'
          });
        ...
        if (customform == 14 && review == null) {
          ...
          title_imagesInjerto = formulario.addField({
            id: 'custpage_images_injerto',
            type: 'INLINEHTML',
            label: 'medico injerto'
          });
          title_imagesInjerto.defaultValue = '</br><h1>IMÁGENES MÉDICO INJERTO</h1><hr>';
          title_imagesInjerto.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          title_imagesInjerto.updateBreakType({
            breakType: 'STARTROW'
          });
          ...
          field_image_1 = formulario.addField({
            id: 'custpage_image_1',
            type: 'file',
            label: 'DISEÑO IMAGEN 1'
          });
          field_image_1.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_1.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_1.updateBreakType({
            breakType: 'STARTCOL'
          ...
          field_image_5 = formulario.addField({
            id: 'custpage_image_5',
            type: 'file',
            label: 'IMAGEN DESPUÉS 1'
          });
          field_image_5.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          ...
          field_image_2 = formulario.addField({
            id: 'custpage_image_2',
            type: 'file',
            label: 'DISEÑO IMAGEN 2'
          });
          field_image_2.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_2.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_6 = formulario.addField({
            id: 'custpage_image_6',
            type: 'file',
            label: 'IMAGEN DESPUÉS 2'
          });
          field_image_6.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          ...
          field_image_3 = formulario.addField({
            id: 'custpage_image_3',
            type: 'file',
            label: 'DISEÑO IMAGEN 3'
          });
          field_image_3.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_3.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_7 = formulario.addField({
            id: 'custpage_image_7',
          ...
          field_image_7.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          ...
          field_image_4 = formulario.addField({
            id: 'custpage_image_4',
            type: 'file',
            label: 'DISEÑO IMAGEN 4'
          });
          field_image_4.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_4.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_8 = formulario.addField({
            id: 'custpage_image_8',
          ...
          field_image_8.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          //FOTOS ENFERMERIA - ANTES
          title_imagesEnfermeriaAntes = formulario.addField({
            id: 'custpage_images_enfermeria_antes',
            type: 'INLINEHTML',
            label: 'enfermeria antes'
          });
          title_imagesEnfermeriaAntes.defaultValue = '</br><h1>IMAGENES ENFERMERIA ANTES</h1><hr>';
          title_imagesEnfermeriaAntes.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          title_imagesEnfermeriaAntes.updateBreakType({
            breakType: 'STARTROW'
          });
          ...
          field_image_9 = formulario.addField({
            id: 'custpage_image_9',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 1'
          });
          field_image_9.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_9.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_9.updateBreakType({
            breakType: 'STARTCOL'
          });
          field_image_13 = formulario.addField({
            id: 'custpage_image_13',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 5'
          });
          field_image_13.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          ...
          field_image_10 = formulario.addField({
            id: 'custpage_image_10',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 2'
          });
          field_image_10.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_10.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_14 = formulario.addField({
            id: 'custpage_image_14',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 6'
          });
          field_image_14.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          field_image_11 = formulario.addField({
            id: 'custpage_image_11',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 3'
          });
          field_image_11.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_11.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_15 = formulario.addField({
            id: 'custpage_image_15',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 7'
          });
          field_image_15.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          field_image_12 = formulario.addField({
            id: 'custpage_image_12',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 4'
          });
          field_image_12.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_12.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_16 = formulario.addField({
            id: 'custpage_image_16',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA ANTES 8'
          });
          field_image_16.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          //FOTOS ENFERMERIA - DESPUES
          title_imagesEnfermeriaDespues = formulario.addField({
            id: 'custpage_images_enfermeria_despues',
            type: 'INLINEHTML',
            label: 'enfermeria despues'
          });
          title_imagesEnfermeriaDespues.defaultValue = '</br><h1>IMAGENES ENFERMERIA DESPUÉS</h1><hr>';
          title_imagesEnfermeriaDespues.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          title_imagesEnfermeriaDespues.updateBreakType({
            breakType: 'STARTROW'
          });

          field_image_17 = formulario.addField({
            id: 'custpage_image_17',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 1'
          });
          field_image_17.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_17.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_17.updateBreakType({
            breakType: 'STARTCOL'
          });
          field_image_21 = formulario.addField({
            id: 'custpage_image_21',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 5'
          });
          field_image_21.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          field_image_18 = formulario.addField({
            id: 'custpage_image_18',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 2'
          });
          field_image_18.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_18.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_22 = formulario.addField({
            id: 'custpage_image_22',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 6'
          });
          field_image_22.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          field_image_19 = formulario.addField({
            id: 'custpage_image_19',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 3'
          });
          field_image_19.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_19.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_23 = formulario.addField({
            id: 'custpage_image_23',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 7'
          });
          field_image_23.updateLayoutType({
            layoutType: 'OUTSIDE'
          });

          field_image_20 = formulario.addField({
            id: 'custpage_image_20',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 4'
          });
          field_image_20.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
          field_image_20.updateBreakType({
            breakType: 'STARTROW'
          });
          field_image_24 = formulario.addField({
            id: 'custpage_image_24',
            type: 'file',
            label: 'IMAGEN ENFERMERÍA DESPUÉS 8'
          });
          field_image_24.updateLayoutType({
            layoutType: 'OUTSIDE'
          });
        ...
        for (var r in arr_nameFolderReview) {
          if (arr_nameFolderReview[r].index == review) {
            nameFolderReview = arr_nameFolderReview[r].text
          }
        }
