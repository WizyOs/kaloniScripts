...
// var body_mail = Procedimiento6_MX2020.html
...
'<title>¿Cómo estimular el crecimiento del cabello?</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE 3 MESES, O AL DÍA 91 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982537&c=3559763&h=e3b236c5c1c0efddbd45&fcts=20191125190211&whence=" style="display: block;" width="100%" border="0" alt="Disciplina y perseverancia, las claves para alcanzar tu meta" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Nuestros Expertos entienden tus preocupaciones. </div></td>'+
'              </tr>'+
'				'+
'				<tr><td height="5" style="font-size: 5px; line-height: 5px;"></td></tr>'+
'				'+
'			  <tr><td><div style="color: #456cb3;font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 500;line-height: 23px">En este momento la zona injertada puede lucir despoblada y probablemente sientas que tu imagen no sólo no ha mejorado, sino que se ha visto afectada. Ten paciencia, es parte de la fase de crecimiento del nuevo cabello. </b></div></td></tr>'+
'				'+
...
'					Recuerda que es importante que sigas las indicaciones del médico para asegurar tu mejor resultado.'+
'					</td>'+
'                  </tr>'+
'                </table>'+
'		'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> A partir de este momento se suspenden todas las restricciones. </div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Ya puedes incorporar actividades a tu vida, como entrar a vapor, mar y sauna.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="20" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                                      <tr>'+
'                                        <td width="10"> </td>'+
'                                        <td><div style="line-height: 20px; text-align: left; font-size: 14px;"> Es importante que continúes con el uso del kit Kaloni Complete®.</div></td>'+
'                                      </tr>'+
'                                      <tr>'+
'                                        <td height="10" style="font-size: 10px; line-height: 10px;"> </td>'+
'                                      </tr>'+
...
'                  </tr>'+
'                  <tr>'+
'                    <td height="40" style="color: #333333; font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 25px;font-weight: 600;"> '+
'					Si tienes alguna duda sobre cómo usar el kit Kaloni Complete®, consulta con tu médico, ya sea de forma presencial o virtual.'+
'					</td>'+
'                  </tr>'+
'					<tr>'+
'                    <td height="20" style="font-size: 20px; line-height: 20px;"> </td>'+
...
'                  </tr>'+
'					'+
'				<table border="0" width="490" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">	'+
'                  <tr>'+
...
'					RECUERDA AGENDAR TU CITA DE REVISIÓN DE 4 MESES'+
'					</td>'+
'                  </tr>'+
'				</table>'+
'					'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7091', body_mail); // Disparo mailing 91D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'¿Cómo estimular el crecimiento del cabello?', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 91D to: ', correo);
                      }
                    }
                    count++;
                });
