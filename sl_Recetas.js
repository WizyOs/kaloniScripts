...
function crearPDFCaso(valid) {
    ...
    try {
        ...
        //nlapiLogExecution('DEBUG', 'inRecord: ', inRecord);
        /*return false;*/
        ...
        if (languageInterface == 'en') {
            ...
            label_title_receta_paciente = 'Pharmacy Prescription';
            ...
            label_title_receta_paciente = 'Receta Farmacia';
        ...
        xml += '</table>';
        //nlapiLogExecution('DEBUG', 'PDF Recetas: ', 'Value Medico: ' + doctor);
        ...
        /*   xml += "<table style=\"width:100%;font-size:11px; font-family:'Aria', sans-serif\">";
           xml += '<tr><td colspan=\"2\" color=\"#FFFFFF\" background-color=\"#346094\"><b>TRATAMIENTOS</b></td></tr>';
           xml += '<tr>';
           if(shampooCaidaCheck=="T"){
           xml += '<td><table><tr><td><b><span style=\"font-size:10px;\">SHAMPOO CONTROL CAÍDA</span></b></td></tr><tr><td>'+ind5+'</td></tr></table></td>';
           }
           if(shampooGrasaCheck=="T"){
           xml += "<td><table><tr><td><b><span style=\"font-size:10px;\">SHAMPOO CONTROL GRASA</span></b></td></tr><tr><td>"+ind6+"</td></tr></table></td>";
           }
           xml += '</tr>';
           xml += '<tr>';
           if(aguaGlaciarCheck=="T"){
           xml += '<td><table><tr><td><b><span style=\"font-size:10px;\">AGUA GLACIAR</span></b></td></tr><tr><td>'+ind7+'</td></tr></table></td>';
           }
           if(argininaCheck=="T"){
           xml += '<td><table><tr><td><b><span style=\"font-size:10px;\">ARGININA</span></b></td></tr><tr><td>'+ind8+'</td></tr></table></td>';
           }
           xml += '</tr></table>';

           xml += "<table style=\"width:100%;font-size:11px; font-family:'Aria', sans-serif\">";
             xml += '<tr><td color=\"#FFFFFF\" background-color=\"#346094\"><b>INDICACIONES DE CUIDADO</b></td></tr>';
        ...
        xml += '<p></p>';
        xml += '<p></p>';
        xml += '<p style=\"font-family:Aria, sans-serif\" font-size=\"12px\"><b>' + label_title_responsable_sanitario + ' Dr. ' + resp + '<br />' + resp1 + '</b></p>';
        xml += '</body>\n</pdf>';
