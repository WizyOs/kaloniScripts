    ...
    function (record, log, render, xmlMod) {
        ...
        function onRequest(context) {
            ...
            var avisoMexico = '<p style="width:70%;color:#000000;font-family:Aria, sans-serif;align:center"><b>AUTORIZACIÓN DE USO DE IMAGEN EN FOTOGRAFÍA Y/O VIDEO PARA PUBLICACIÓN Y/O DIFUSIÓN</b></p>' +
                ...
                '<p style="font-family:Aria, sans-serif; font-size:12px;">La presente autorización no estará sujeta a temporalidad alguna; sin embargo, en cumplimiento con la Ley Federal de Protección de Datos Personales en Posesión de Particulares, la autorización será revocable por el “Paciente” en cualquier momento en los términos contenidos en el Aviso de Privacidad de “Kaloni”.</p>' +

                '<p style="font-family:Aria, sans-serif; font-size:12px;">En prueba de conformidad firmo la presente, en <b>' + sucReal + ' a ' + fecha + ' </b></p><br/>' +

                '<p style="font-family:Aria, sans-serif; font-size:12px;">Atentamente, ' + altname + '</p>';
