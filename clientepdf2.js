// test
function portletName(request, response) {
    ...
    try {
        ...
        if (idProsc != null) {
            ...
            if (record2 != null) {
                ...
                var firma_cli = record2.getFieldValue('custevent193');
                if (firma_cli != null) {
                    var firma_cli = "<img height=\"60px\" width=\"120px\" src=\"" + nlapiEscapeXML(firma_cli) + "\"/>";
                    nlapiLogExecution('DEBUG', 'Firma Cliente ', firma_cli);
                } else { firma_cli = ""; }
                var firma_med = record2.getFieldValue('custevent194');
                if (firma_med != null) {
                    var firma_med = "<img height=\"60px\" width=\"120px\" src=\"" + nlapiEscapeXML(firma_med) + "\"/>";
                    nlapiLogExecution('DEBUG', 'Firma Medico ', firma_med);
                } else { firma_med = ""; }

                  var firma_client_Injert = record2.getFieldValue('custevent269');
                if (firma_client_Injert != null) {
                    // var fileImage = nlapiLoadFile(firma_doc_Injert);
                    //var urlImage= fileImage.getValue();
                    var firma_client_Injert = "<img height=\"60px\" width=\"120px\" src=\"" + nlapiEscapeXML(firma_client_Injert) + "\"/>";
                      //var firma_client_Injert="<img height=\"60px\" width=\"120px\" src=\"data:image/png;base64,"+ nlapiEscapeXML(firma_client_Injert) +"\"/>";
                      nlapiLogExecution('DEBUG', 'Firma Consentimiento ', firma_client_Injert);
        ...
        if (PDF_PRESUPUESTO != null && PDF_PRESUPUESTO != "") {
            ...
            var DOCPDFPRE = filePDFPRE.getURL();
        } else { DOCPDFPRE = null; }
        ...
        if (firma_testigo1 != null) {
            ...
            if (record2 != null) {
                //nlapiLogExecution('ERROR', 'Current record2', record2);
                strName += "<pbr/>";
                strName += "<br/>";
                ...
                if (record2 != null) {
                    ...
                    /*strName += "<td width=\"300px\" align=\"center\" valign=\"middle\"><img height=\"15px\" width=\"15px\" src=\"https://system.na2.netsuite.com/core/media/media.nl?id=2094075&c=3559763&h=2e90961872deb60d96a5\">probando</img></td>"; //https://system.na2.netsuite.com/core/media/media.nl?id=740487&amp;c=3559763&amp;h=e1eb9a6dd4127855a2d1*/
                ...
                if (record2 != null) {
                    var LAVADO_DE_24_HORAS_bto = record2.getFieldValue('custevent138');
                    var LAVADO_24HR_NOTA_MEDICA_bto = record2.getFieldValue('custevent139');
                    var TX0_bto = record2.getFieldValue('custevent140');
                    var RESPONSABLE0_bto = record2.getFieldValue('custevent141');

                    var REVISION_10_DIAS_bto = record2.getFieldValue('custevent142');
                    var PRIMERA_NOTA_MEDICA_bto = record2.getFieldValue('custevent143');
                    var TX1_bto = record2.getFieldValue('custevent144');
                    var RESPONSABLE1_bto = record2.getFieldValue('custevent145');
                    // Revisión de 1 Mes
                    var REVISION_3_MESES_bto = record2.getFieldValue('custevent146');
                    var SEGUNDA_NOTA_MEDICA_bto = record2.getFieldValue('custevent147');
                    var TX2_bto = record2.getFieldValue('custevent148');
                    var RESPONSABLE2_bto = record2.getFieldValue('custevent149');
                    // Revisión de 3 Meses
                    var REVISION_5_MESES_bto = record2.getFieldValue('custevent150');
                    var CUARTA_NOTA_MEDICA_bto = record2.getFieldValue('custevent151');
                    var TX4_bto = record2.getFieldValue('custevent152');
                    var RESPONSABLE4_bto = record2.getFieldValue('custevent153');
                    // Revisión de 5 Meses
                    var REVISION_7_MESES_bto = record2.getFieldValue('custevent154');
                    var QUINTA_NOTA_MEDICA_bto = record2.getFieldValue('custevent155');
                    var TX5_bto = record2.getFieldValue('custevent156');
                    var RESPONSABLE5_bto = record2.getFieldValue('custevent157');
                    // Revisión de 7 Meses
                    var REVISION_9_MESES_bto = record2.getFieldValue('custevent158');
                    var SEXTA_NOTA_MEDICA_bto = record2.getFieldValue('custevent159');
                    var TX6_bto = record2.getFieldValue('custevent160');
                    var RESPONSABLE55_bto = record2.getFieldValue('custevent163');
                    // Revisión de 9 Meses
                    var REVISION_99_MESES_bto = record2.getFieldValue('custevent164');
                    var SEXTA9_NOTA_MEDICA_bto = record2.getFieldValue('custevent165');
                    var TX66_bto = record2.getFieldValue('custevent166');
                    var RESPONSABLE6_bto = record2.getFieldValue('custevent167');
                    // Revisión de 12 Meses
                    var REVISION_12_MESES_bto = record2.getFieldValue('custevent168');
                    var SEPTIMA_NOTA_MEDICA_bto = record2.getFieldValue('custevent169');
                    var TX7_bto = record2.getFieldValue('custevent170');
                    var RESPONSABLE7_bto = record2.getFieldValue('custevent171');
                    // Revisión de 14 Meses
                    var REVISION_14_MESES_bto = record2.getFieldValue('custevent172');
                    var OCTAVA_NOTA_MEDICA_bto = record2.getFieldValue('custevent173');
                    var TX8_bto = record2.getFieldValue('custevent174');
                    var RESPONSABLE8_bto = record2.getFieldValue('custevent175');
                    ...
                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(LAVADO_DE_24_HORAS_bto) + ""; // Days24
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(LAVADO_DE_24_HORAS_bto) + ""; // Days24
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(LAVADO_24HR_NOTA_MEDICA_bto) + "</u></p>"; // nota24horas
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX0_bto) + ""; // medicam1
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE0_bto) + ""; // Responsable1
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_10_DIAS_bto) + ""; // Day10
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_10_DIAS_bto) + ""; // Day10
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(PRIMERA_NOTA_MEDICA_bto) + "</u></p>"; // nota
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX1_bto) + ""; // medicam2
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE1_bto) + ""; // Responsable2
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_3_MESES_bto) + ""; // Mes1
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_3_MESES_bto) + ""; // Mes1
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(SEGUNDA_NOTA_MEDICA_bto) + "</u></p>"; // nota2
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX2_bto) + ""; // medicam3
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE2_bto) + ""; // Responsable3
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_5_MESES_bto) + ""; // Mes3
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_5_MESES_bto) + ""; // Mes3
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(CUARTA_NOTA_MEDICA_bto) + "</u></p>"; // nota3
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX4_bto) + ""; // medicam4
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE4_bto) + ""; // Responsable4
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";
                    ...
                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_7_MESES_bto) + ""; // Mes5
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_7_MESES_bto) + ""; // Mes5
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(QUINTA_NOTA_MEDICA_bto) + "</u></p>"; // nota4
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX5_bto) + ""; // medicam5
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE5_bto) + ""; // Responsable5
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_9_MESES_bto) + ""; // Mes7
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_9_MESES_bto) + ""; // Mes7
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(SEXTA_NOTA_MEDICA_bto) + "</u></p>"; // nota10
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX6_bto) + ""; // medicam10
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE55_bto) + ""; // Responsable10
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_99_MESES_bto) + ""; // Mes9
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_99_MESES_bto) + ""; // Mes9
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(SEXTA9_NOTA_MEDICA_bto) + "</u></p>"; // nota5
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX66_bto) + ""; // medicam6
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE6_bto) + ""; // Responsable6
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td valign=\"top\">" + dates(REVISION_12_MESES_bto) + ""; // Mes12
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_12_MESES_bto) + ""; // Mes12
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(SEPTIMA_NOTA_MEDICA_bto) + "</u></p>"; // nota6
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX7_bto) + ""; // medicam7
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE7_bto) + ""; // Responsable7
                    strName += "<hr border=\"1px\"/></td>";
                    strName += "</tr>";

                    strName += "<tr>";

                    strName += "<td valign=\"top\">" + dates(REVISION_14_MESES_bto) + ""; // Mes14
                    strName += "</td>";
                    ...
                    strName += "<td >";
                    strName += "" + checado(REVISION_14_MESES_bto) + ""; // Mes14
                    strName += "</td>";

                    strName += "<td >";
                    strName += "<p><u>" + checado(OCTAVA_NOTA_MEDICA_bto) + "</u></p>"; // nota7
                    strName += "</td>";

                    strName += "<td >";
                    strName += "" + checado(TX8_bto) + ""; // medicam8
                    strName += "</td>";
                    strName += "</tr>";

                    strName += "<tr>";
                    strName += "<td colspan=\"5\">Nombre del Responsable: " + checado(RESPONSABLE8_bto) + ""; // Responsable8
                    strName += "</td>";
                    strName += "</tr>";
                    strName += "</table>";
            ...
            xml += "</body>\n</pdf>";
            xml += "</pdfset>";
            /*nlapiLogExecution('ERROR', 'Current Error', xml);
            var newFile1 = nlapiCreateFile('actualizarExp.txt', 'PLAINTEXT', xml);
            newFile1.setFolder('1039537');
            nlapiSubmitFile(newFile1);*/
            ...
            var folderPath = parentP.getSelectOptions("EXP_MEXICO");

            // if EXP_MEXICO (if level 1) -----------------------------
            if (folderPath.length != 0) {
                var idPath = folderPath[0].getId(); // id folder EXP_MEXICO
                ...
                // if Sucursal KHG_HAIR (if level 2) -------------------------------
                if (folderSubP.length != 0) {
                    var idPathSub = folderSubP[0].getId(); // id folder Sucursal KHG_HAIR
                    ...
                    // if HG-70494_FOLDER (if level 3) --------------------------------
                    if (folderList.length != 0) {
                        var idsfol = folderList[0].getId(); // id folder HG_FOLDER
                        // Eliminar pdf actual
                        try {
                        ...
                        var val_aparatologia_mex = record.getFieldValue('custentity365');
                        //nlapiLogExecution('audit', 'Valor custentity365', val_aparatologia_mex);
                        if (val_aparatologia_mex == null || val_aparatologia_mex == "") {
                            var folder_aparatologia_mex = nlapiCreateRecord('folder');
                            if (folder_aparatologia_mex) {
                                folder_aparatologia_mex.setFieldValue('name', 'Aparatología');
                                folder_aparatologia_mex.setFieldValue('parent', idsfol);
                                //nlapiLogExecution('audit', 'Valor idsfol', idsfol);
                                var id_folder_aparatologia_mex = nlapiSubmitRecord(folder_aparatologia_mex);
                                if (id_folder_aparatologia_mex != null && id_folder_aparatologia_mex !== "") {
                                    record.setFieldValue('custentity365', id_folder_aparatologia_mex);
                                    //var valResponsefolderAparatologia = nlapiSubmitRecord(record);
                                    //nlapiLogExecution('audit', 'Valor valResponsefolderAparatologia', valResponsefolderAparatologia);
                                    var newAttachmentTXT = nlapiCreateFile('NetSuiteInf.txt', 'PLAINTEXT', 'Archivo creado por script');
                                    newAttachmentTXT.setFolder(id_folder_aparatologia_mex);
                                    newAttachmentTXT.setEncoding('UTF-8');
                                    nlapiSubmitFile(newAttachmentTXT);
                                }
                            }
                        }
                        ...
                        try {
                            ...
                            // crear carpetas de revisiones 24 hrs hasta 14 meses
                        ...
                        if (val_aparatologia_mex == null || val_aparatologia_mex == "") {
                            ...
                            if (folder_aparatologia_mex) {
                                folder_aparatologia_mex.setFieldValue('name', 'Aparatología');
                                folder_aparatologia_mex.setFieldValue('parent', subFolderId);
                                //nlapiLogExecution('audit', 'Valor idsfol', subFolderId);
                                var id_folder_aparatologia_mex = nlapiSubmitRecord(folder_aparatologia_mex);
                                if (id_folder_aparatologia_mex != null && id_folder_aparatologia_mex !== "") {
                                    record.setFieldValue('custentity365', id_folder_aparatologia_mex);
                                    //var valResponsefolderAparatologia = nlapiSubmitRecord(record, false, true);
                                    //nlapiLogExecution('audit', 'Valor valResponsefolderAparatologia', valResponsefolderAparatologia);
                                    var newAttachmentTXT = nlapiCreateFile('NetSuiteInf.txt', 'PLAINTEXT', 'Archivo creado por script');
                                    newAttachmentTXT.setFolder(id_folder_aparatologia_mex);
                                    newAttachmentTXT.setEncoding('UTF-8');
                ...
                } // Fin if Sucursal KHG_HAIR (if level 2)
                else {
                    ...
                    if (subFolderId2 != null) // if existe EXP_MEXICO > Sucursal KHG_HAIR
                    {
                        var folderC = nlapiCreateRecord('folder');
                        var parentC = folderC.getField('parent');
                        var folderList = parentC.getSelectOptions(id + "_FOLDER");

                        if (folderList.length != 0) // if existe EXP_MEXICO > Sucursal KHG_HAIR > HG-70494_FOLDER
                        {
                            ...
                            // crear carpetas revisiones 24 hrs hasta 14 meses dentro de >HG_FOLDER
                            try {
                                var FOLD24H = nlapiCreateRecord('folder');
                                FOLD24H.setFieldValue('name', 'R24HORAS');
                                FOLD24H.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_24H = nlapiSubmitRecord(FOLD24H, true);
                                ...
                                var FOLD10D = nlapiCreateRecord('folder');
                                FOLD10D.setFieldValue('name', 'R10DIAS');
                                FOLD10D.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_10D = nlapiSubmitRecord(FOLD10D, true);
                                ...
                                var FOLD1MES = nlapiCreateRecord('folder');
                                FOLD1MES.setFieldValue('name', 'R1MES');
                                FOLD1MES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_1MES = nlapiSubmitRecord(FOLD1MES, true);
                                ...
                                var FOLD3MESES = nlapiCreateRecord('folder');
                                FOLD3MESES.setFieldValue('name', 'R3MESES');
                                FOLD3MESES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_3MESES = nlapiSubmitRecord(FOLD3MESES, true);
                                ...
                                var FOLD5MESES = nlapiCreateRecord('folder');
                                FOLD5MESES.setFieldValue('name', 'R5MESES');
                                FOLD5MESES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_5MESES = nlapiSubmitRecord(FOLD5MESES, true);
                                ...
                                var FOLD7MESES = nlapiCreateRecord('folder');
                                FOLD7MESES.setFieldValue('name', 'R7MESES');
                                FOLD7MESES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_7MESES = nlapiSubmitRecord(FOLD7MESES, true);
                                ...
                                var FOLD9MESES = nlapiCreateRecord('folder');
                                FOLD9MESES.setFieldValue('name', 'R9MESES');
                                FOLD9MESES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_9MESES = nlapiSubmitRecord(FOLD9MESES, true);
                                ...
                                var FOLD12MESES = nlapiCreateRecord('folder');
                                FOLD12MESES.setFieldValue('name', 'R12MESES');
                                FOLD12MESES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_12MESES = nlapiSubmitRecord(FOLD12MESES, true);
                                ...
                                var FOLD14MESES = nlapiCreateRecord('folder');
                                FOLD14MESES.setFieldValue('name', 'R14MESES');
                                FOLD14MESES.setFieldValue('parent', subFolderId); // parent subFolderId2
                                var ID_FOL_14MESES = nlapiSubmitRecord(FOLD14MESES, true);
            ...
            } // Fin if EXP_MEXICO (if level 1)
            else {
                var folderPath = nlapiCreateRecord('folder');
                folderPath.setFieldValue('name', 'EXP_MEXICO');
                var parentFolderId = nlapiSubmitRecord(folderPath, true);
            }

            // crear carpetas medical EXP_MEDICAL > Sucursal MED > HG-70494M > Aparatología 
            var folder_sucursal_exp_medical = nlapiCreateRecord('folder');
            var folder_sucursal_exp_medical_parent = folder_sucursal_exp_medical.getField('parent');

            var prefijo_sucursal = sucursal.substring(0, 3);
            if (prefijo_sucursal == "Alt")
                prefijo_sucursal = "Altavista MED";
            if (prefijo_sucursal == "Can")
                prefijo_sucursal = "Can-Cun MED";
            if (prefijo_sucursal == "Chi")
                prefijo_sucursal = "Chihuahua MED";
            if (prefijo_sucursal == "Gua")
                prefijo_sucursal = "Guadalajara MED";
            if (prefijo_sucursal == "Mon")
                prefijo_sucursal = "Monterrey MED";
            if (prefijo_sucursal == "Pol")
                prefijo_sucursal = "Polanco MED";
            if (prefijo_sucursal == "Pue")
                prefijo_sucursal = "Puebla MED";
            if (prefijo_sucursal == "San")
                prefijo_sucursal = "Santa Fe MED";
            if (prefijo_sucursal == "Sat")
                prefijo_sucursal = "Satelite MED";
            if (prefijo_sucursal == "Tij")
                prefijo_sucursal = "Tijuana MED";
            if (prefijo_sucursal == "Ver")
                prefijo_sucursal = "Veracruz MED";
            nlapiLogExecution('ERROR', 'sucursal: ', sucursal);
            var folder_sucursal_exp_medical_parent_path = folder_sucursal_exp_medical_parent.getSelectOptions(prefijo_sucursal);

            var id_folder_sucursal_exp_med = "";
            if (folder_sucursal_exp_medical_parent_path.length != 0) {
                id_folder_sucursal_exp_med = folder_sucursal_exp_medical_parent_path[0].getId(); // id folder Sucursal MED
            }
            else {
                var folder_sucursal_exp_medical2 = nlapiCreateRecord('folder');
                folder_sucursal_exp_medical2.setFieldValue('name', prefijo_sucursal);
                folder_sucursal_exp_medical2.setFieldValue('parent', '749635');
                id_folder_sucursal_exp_med = nlapiSubmitRecord(folder_sucursal_exp_medical2); // id folder Sucursal MED
            }

            var folder_hgM_exp_medical = nlapiCreateRecord('folder');
            var folder_hgM_exp_medical_parent = folder_hgM_exp_medical.getField('parent');
            var folder_hgM_exp_medical_parent_path = folder_hgM_exp_medical_parent.getSelectOptions(id + "M");

            var id_folder_hgM_exp_med = "";
            if (folder_hgM_exp_medical_parent_path.length != 0) {
                id_folder_hgM_exp_med = folder_hgM_exp_medical_parent_path[0].getId(); // id folder HG-70494M 
            }
            else {
                var folder_hgM_exp_medical2 = nlapiCreateRecord('folder');
                folder_hgM_exp_medical2.setFieldValue('name', id + "M");
                folder_hgM_exp_medical2.setFieldValue('parent', id_folder_sucursal_exp_med);
                id_folder_hgM_exp_med = nlapiSubmitRecord(folder_hgM_exp_medical2); // id folder HG-70494M 
            }

            var val_aparatologia_mex_med = record.getFieldValue('custentity366');
            if (val_aparatologia_mex_med == null || val_aparatologia_mex_med == "") {
                var folder_aparatologia_mex_med = nlapiCreateRecord('folder');
                folder_aparatologia_mex_med.setFieldValue('name', 'Aparatología');
                folder_aparatologia_mex_med.setFieldValue('parent', id_folder_hgM_exp_med);
                var id_folder_aparatologia_mex_med = nlapiSubmitRecord(folder_aparatologia_mex_med);
                if (id_folder_aparatologia_mex_med != null && id_folder_aparatologia_mex_med !== "") {
                    record.setFieldValue('custentity366', id_folder_aparatologia_mex_med);
