...
function(record,log,search,redirect,file,format,https,encode) {
    ...
    function onRequest(context) {
      var recId = context.request.parameters.recordCreditMemoId;
      ...
      var folderToSaveCreditMemo = createFolders(mes_Co, anio_Co); // .toString()
      ...
      if(fecha.indexOf('202') >= 0 && fecha.indexOf(':') >= 0) // "2020-03-19 04:42:09"
      {
          ...
          folderToSaveCreditMemo = createFolders(mes_Co, anio_Co);
      ...
      var creditMemo = record.load({type: 'creditmemo', id: recId}); // 629157

	  // seccion01 --------------------------------------------------------------------------------------------------------------
	  // Campos que identifican a la NC (No. Elementos: 1) Obligatorio

      var tranidVal = creditMemo.getValue({fieldId: 'tranid'}); // NC-COL-00162
      try{ tranidVal = tranidVal.replace(/-/g, ''); }catch(e){log.debug("Exception: ", e);}
      log.debug('tranidVal: ', tranidVal);

      var seccion01 = "01|";
      var codigoTipoDocumento_01 = "91";
      var motivo_de_la_NC = creditMemo.getValue({fieldId: 'custbody98'});
      //var descripcion_de_motivo_01 = creditMemo.getValue({fieldId: 'custbody111'});
      var secuencial_01 = tranidVal; // "SETT49" 								// ? tranidVal
      var fechaDeEmision_01 = anio_Co + "-" + mes_Co + "-" + dia_Co;
      var horaDeEmision_01 = hourAuxHH +":"+ hourAuxMM +":"+ hourAuxSS;
      var tipoDeOperacion_01 = "05";
      //var idReferecia_01 = ""; 						  			    // ? "18347124512"
      //var fechaDeEmisionReferencia_01 = "";
      //var prefijo_01 = creditMemo.getText({fieldId: 'custbody112'});
      seccion01 += codigoTipoDocumento_01 +"|"+ motivo_de_la_NC +"|"+ secuencial_01 +"|"+ fechaDeEmision_01 +"|"+ horaDeEmision_01 +"|"+ tipoDeOperacion_01 +"\n";

	  // seccion02 ---------------------------------------------------------------------------------------------------------------
	  // Información del emisor (No. Elementos: 1) Obligatorio
	  var creadaDesde = creditMemo.getText({fieldId: 'createdfrom'});
      log.debug('creadaDesde: ', creadaDesde);
      ...
      var nombreComercial_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "KALONI COLOMBIA" : "KALONI COLOMBIA MEDELLIN";
      var tipoDeOrganización_02 = "1";
      var codigoDepartamento_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "11" : "05";
      var departamento_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "Bogotá" : "Antioquia";
      var codigoMunicipio_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "11001" : "05001";
      // var municipio_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "BOGOTÁ, D.C." : "MEDELLÍN";
      var ciudad_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "BOGOTÁ, D.C." : "MEDELLÍN";
      var direccion_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "AK 9 113 52 EDIFICIO TORRES UNIDAS 2 LC 102" : "CL 13 34 31 ED TRIANGLE";
      var codigoPais_02 = "CO";
      var nombreDelPais_02 = "Colombia";
      var regimen_02 = "05";
      var codigoPostal_02 = (creadaDesde.indexOf("BOG") != -1 && locationText.indexOf("Bogota") != -1) ? "110911" : "050022";					// ?
      ...
      seccion02 += tipoDeIdentificacion_02 +"|"+ identificacion_02 +"|"+ razonSocial_02 +"|"+ nombreComercial_02 +"|"+ tipoDeOrganización_02 +"|"+ codigoDepartamento_02 +"|"+ departamento_02 +"|"+ codigoMunicipio_02 +"|"+ ciudad_02 +"|"+ direccion_02 +"|"+ codigoPais_02 +"|"+ nombreDelPais_02 +"|"+ regimen_02 +"|"+ codigoPostal_02 +"|"+ actividadEconomica_02 +"|"+ obligacionesDelContribuyente_02 +"|"+ detallesTributariosDelEmisor_02 +"|"+ NumeroDeMatriculaMercantil_02 +"\n";

      // seccion03 ---------------------------------------------------------------------------------------------------------------
      // Información del receptor (No. Elementos: 1-N) Obligatorio

      var custbody113 = creditMemo.getText({fieldId: 'custbody113'});
      if(custbody113 === "Registro civil")
         custbody113 = "11";
      if(custbody113 === "Tarjeta de identidad")
         custbody113 = "12";
      if(custbody113 === "Cédula de ciudadanía")
         custbody113 = "13";
      if(custbody113 === "Tarjeta de extranjería")
         custbody113 = "21";
      if(custbody113 === "Cédula de extranjería")
         custbody113 = "22";
      if(custbody113 === "NIT")
         custbody113 = "31";
      if(custbody113 === "Pasaporte")
         custbody113 = "41";
      var custbody119 = creditMemo.getText({fieldId: 'custbody119'});
      var ciudad_Aux = custbody119;
      custbody119 = getCodigoMunicipio(custbody119);
      var custbody121 = creditMemo.getText({fieldId: 'custbody121'});
      if(custbody121 == "Simplificado")
        custbody121 = "04";
      if(custbody121 == "Común")
        custbody121 = "05";
      var custbody125 = creditMemo.getValue({fieldId: 'custbody125'});
      if(custbody125.substring(custbody125.length -1, custbody125.length) === ";")
        custbody125 = custbody125.substring(0, custbody125.length -1);
      var custbody128 = creditMemo.getValue({fieldId: 'custbody128'});
      if(custbody128.substring(custbody128.length -1, custbody128.length) === "+")
        custbody128 = custbody128.substring(0, custbody128.length -1);

	  var seccion03 = "03|";
      var tipoDeIdentificacion_03 = custbody113;
      var identificacion_03 = creditMemo.getValue({fieldId: 'custbody114'});
      var razonSocial_03 = creditMemo.getValue({fieldId: 'custbody115'});
      var nombreComercial_03 = creditMemo.getValue({fieldId: 'custbody116'});
      var tipoDeOrganizacion_03 = creditMemo.getValue({fieldId: 'custbody117'});
      var codigoDepartamento_03 = getCodigoDep(creditMemo.getText({fieldId: 'custbody118'}));
      var departamento_03 = creditMemo.getText({fieldId: 'custbody118'});
      var codigo_municipio_03 = custbody119;
      //var municipio_03 = ciudad_Aux;
      var ciudad_03 = ciudad_Aux;
      var direccion_03 = creditMemo.getValue({fieldId: 'custbody120'});
      var codigoPais_03 = "CO";
      var nombreDelPais_03 = "Colombia";
      var regimen_03 = custbody121;
      var email_03 = creditMemo.getValue({fieldId: 'custbody122'}); // "acolin@kaloni.com"
      var telefono_03 = creditMemo.getValue({fieldId: 'custbody123'});
      var codigoPostal_03 = creditMemo.getValue({fieldId: 'custbody124'});							// ?
      var obligacionesDelContribuyente_03 = custbody125;
      var detallesTributariosDelReceptor_03 = custbody128;
      seccion03 += tipoDeIdentificacion_03 +"|"+ identificacion_03 +"|"+ razonSocial_03 +"|"+ nombreComercial_03 +"|"+ tipoDeOrganizacion_03 +"|"+ codigoDepartamento_03 +"|"+ departamento_03 +"|"+ codigo_municipio_03 +"|"+ ciudad_03 +"|"+ direccion_03 +"|"+ codigoPais_03 +"|"+ nombreDelPais_03 +"|"+ regimen_03 +"|"+ email_03 +"|"+ telefono_03 +"|"+ codigoPostal_03 +"|"+ obligacionesDelContribuyente_03 +"|"+ detallesTributariosDelReceptor_03 +"\n";

      log.debug('seccion03: ', seccion03);
      //return false;

      // secc_12_13_14y15
      var item_Lines11 = creditMemo.getLineCount({sublistId : 'item'});
      if(item_Lines11 > 0)
      {
        for(var i = 0; i < item_Lines11; i++)
        {
          var valor_codigo = creditMemo.getSublistValue({sublistId:'item', fieldId:'item', line:i}); // codigo item
          var valor_description = creditMemo.getSublistText({sublistId:'item', fieldId:'description', line:i}); //descripcion
          var valor_units_display = creditMemo.getSublistValue({sublistId:'item', fieldId:'units_display', line:i}); // unidades
          ...
          var valor_amount = creditMemo.getSublistValue({sublistId:'item', fieldId:'amount', line:i}); // precio total item (precio unitario item * cantidad)
          if(valor_amount == null || valor_amount == "")
             valor_amount = (valor_rate * valor_quantity);
          var valor_taxrate1 = creditMemo.getSublistValue({sublistId:'item', fieldId:'taxrate1', line:i}); // porcentaje impuesto aplicado
          ...
          var valor_itemtype = creditMemo.getSublistValue({sublistId:'item', fieldId:'itemtype', line:i}); // itemtype
          var itemObj = {
      ...
      if(newArrayItemsDescuentos.length > 1){
        log.debug("Descuentos > 1: ", "No. de Descuentos: " + newArrayItemsDescuentos.length);
        return false;
      }
      ...
      var razon_de_descuento = "";
      var porcentaje_de_descuento = 0;
      var monto_base_descuento = 0;
      var valor_del_descuento = 0;
      ...
      newArrayItems.forEach(function(element){
        ...
        */
		  ...
		  var precioReferencialItem = element["precio_total_item"].toFixed(2) < 1 ? 1 : 0;
          secc_12_13_14y15 += "12|"+ numItem +"|"+ dianCode +"|"+ element["codigo_item"] +"|"+ element["descripcion"] +"|"+ element["cantidad"] +"|"+ element["cantidad"] +"|94|"+ element["precio_unitario_item"].toFixed(2) +"|01|"+ element["precio_total_item"].toFixed(2) +"|"+ element["unidades"] +"|0|"+precioReferencialItem+"||\n";
          ...
          if((element["descripcion"] === "MANTENIMIENTO PREVENTIVO COL" || element["descripcion"] === "HONORARIOS MICROINJERTO DE CABELLO COL") && (newArrayItemsDescuentos.length > 0)){
            ...
            var porcentajeDescuento = (info_descuento.descuento/element["precio_total_item"])*100;
		  	/*secc_12_13_14y15 += "14|"+ numItem +"|"+ numItem +"|FALSE|"+ info_descuento.descriptionTofind +"|"+ porcentajeDescuento.toFixed(2) +"|"+ info_descuento.descuento +"|"+ element["precio_total_item"] +"\n";*/
            // Copiar datos descuento a seccion 04
            razon_de_descuento = info_descuento.descriptionTofind;
            porcentaje_de_descuento = porcentajeDescuento.toFixed(2);
            monto_base_descuento = element["precio_total_item"];
            valor_del_descuento = info_descuento.descuento;
          }
      ...
      var subtotal = creditMemo.getText({fieldId: 'subtotal'});
      try{ subtotal = subtotal.replace(/,/g, ''); }catch(e){log.debug("Exception: ", e);}
      var taxtotal = creditMemo.getText({fieldId: 'taxtotal'});
      try{ taxtotal = taxtotal.replace(/,/g, ''); }catch(e){log.debug("Exception: ", e);}
      var total = creditMemo.getText({fieldId: 'total'});
      ...
      if(item_Lines > 0)
      {
         for(var i = 0; i < item_Lines; i++)
         {
            ...
            //var item_Description = creditMemo.getSublistValue({sublistId:'item', fieldId:'description', line:i});
		    var item_porcentajeImpuesto = creditMemo.getSublistText({sublistId:'item', fieldId:'taxrate1', line:i});
             try{
      ...
      var identificacionDeUnidad_10 = "94";										// ?
      var valorDelTributoPorUnidad_10 = "";												// ?
      seccion10 += códigoImpuesto_10 +"|"+ valorSinImpuesto_10 +"|"+ porcentajeImpuesto_10  +"|"+ totalImpuesto_10 +"|"+ unidadDeMedida_10 +"|"+ identificacionDeUnidad_10 +"|"+ valorDelTributoPorUnidad_10 + "\n";

      // seccion11 ---------------------------------------------------------------------------------------------------------------
      // Totales (No. Elementos: 1)

	  var seccion11 = "11|";
      var subtotalNC_11 = subtotal;
      var totalBaseImponible_11 = taxtotal;
      var totalValorBrutoMasImpuestos_11 = total;
      var totalNC_11 = total;
      var descuentoTotal_11 = "0.00"; // valor_del_descuento.toFixed(2);										// ?
      var totalCargos_11 = "0.00";											// ?
      var totalAnticipos_11 = "0.00";										// ?
      var moneda_11 = "COP";
	  seccion11 += subtotalNC_11 +"|"+ totalBaseImponible_11 +"|"+ totalValorBrutoMasImpuestos_11  +"|"+ totalNC_11 +"|"+ descuentoTotal_11 +"|"+ totalCargos_11 +"|"+ totalAnticipos_11 +"|"+ moneda_11 + "\n";


	  // seccion17 ---------------------------------------------------------------------------------------------------------------
	  // Información para referenciar la factura electrónica afectada por la NC (No. Elementos: 1-N) Obligatorio
	  var fechaDocumentoSustentoAux = creditMemo.getText({fieldId: 'custbody148'}); // 8/11/2019
      var fechaDocumentoSustentoAux_Split = fechaDocumentoSustentoAux.split('/');
      var dia_Aux = ('0' + fechaDocumentoSustentoAux_Split[0]).slice(-2);
      var mes_Aux = ('0' + fechaDocumentoSustentoAux_Split[1]).slice(-2);
      var anio_Aux = fechaDocumentoSustentoAux_Split[2].substring(0, 4);

      var seccion17 = "17|";
      var secuencialDocumentoSustento_17 = creditMemo.getText({fieldId: 'custbody146'});
      var cufe_17 = creditMemo.getText({fieldId: 'custbody147'});
      var fechaDocumentoSustento_17 = anio_Aux + "-" + mes_Aux + "-" + dia_Aux;
      var descripcionDelMotivo_17 = creditMemo.getText({fieldId: 'custbody149'});
      seccion17 += secuencialDocumentoSustento_17 +"|"+ cufe_17 +"|"+ fechaDocumentoSustento_17 +"|"+ descripcionDelMotivo_17 +"\n";

      // seccion19 --------------------------------------------------------------------------------------------------------------- // ?
      // Pagos de la Factura (No. Elementos: 1)

      var custbody150 = creditMemo.getValue({fieldId: 'custbody150'});
      var custbody151 = creditMemo.getText({fieldId: 'custbody151'});
      custbody151 = getCodigoMedioPago(custbody151);

      var seccion19 = "19|";
      var metodoDePago_19 = "1"; //	custbody150
      var medioDePago_19 = custbody151;
      ...
      var content_txt = seccion01 + seccion02 + seccion03 + seccion10 + seccion11 + secc_12_13_14y15 + seccion17 + seccion19;
	  ...
	  //var body1 = JSON.stringify({"txtEncode": content_txt_base64, "adjunto": "", "nombreAdjunto": tranidVal});
      ...
      if(responseAPI.body.indexOf("Documento Autorizado") != -1)
      {
        var fileObj = file.create({
            name: 'NC_'+ tranidVal + '_' + dia_Co + mes_Co + anio_Co + '_' + hourAuxHH + hourAuxMM + hourAuxSS + '.txt',
            fileType: file.Type.PLAINTEXT,
            contents: content_txt,
            encoding: file.Encoding.UTF8,
            folder: folderToSaveCreditMemo,
            isOnline: false
        });
        var txt_fileId = fileObj.save();

        log.debug('Status: ', 'Documento Autorizado: ' + txt_fileId.toString() + '_' + 'NC_'+ tranidVal + '_' + dia_Co + mes_Co + anio_Co + '_' + hourAuxHH + hourAuxMM + hourAuxSS + '.txt');
        creditMemo.setValue({fieldId: "custbody152", value: 'Documento Autorizado'});
        creditMemo.save({enableSourcing: false, ignoreMandatoryFields: true});
        redirect.toRecord({type : 'creditmemo', id : recId});
      }
      else
      {
        creditMemo.setValue({fieldId: "custbody152", value: 'Documento Rechazado'});
        creditMemo.save({enableSourcing: false, ignoreMandatoryFields: true});
        redirect.toRecord({type : 'creditmemo', id : recId});
      ...
      */
      ...
      //context.response.write(txt_fileId.toString());
...
function getCodigoDep(nombreDep){
  ...
  function getDescuentoItem(item){
      ...
      newArrayItemsDescuentos.forEach(function(elemento){
          ...
          {*/
            var descuentoStr = elemento["precio_total_item"].toString();
