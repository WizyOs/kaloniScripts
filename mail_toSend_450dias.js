...
// var body_mail = Procedimiento17_MX2020.html
...
'<title>¿Hace cuánto renovaste tu imagen por última vez?</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO 15 MESES DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=3983086&c=3559763&h=3ec365f56dcfd7106531&mv=k3fcfspc&_xt=.html&fcts=20191125201154&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3983085&c=3559763&h=5d08dd1015ed8be8ed67&fcts=20191127102525&whence=" style="display: block;" width="100%" border="0" alt="¿Hace cuánto renovaste tu imagen por última vez?" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Acude a nuestras clínicas Kaloni </div></td>'+
'              </tr>'+
'				'+
...
'				  '+
'				y pregunta por el paquete de tratamientos para rostro y cuerpo que hemos diseñado exclusivamente para ti.'+
'				  '+
'				  </div></td></tr>'+
'				'+
...
'                  </tr>'+
'					'+
'				<table border="0" width="460" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">'+
'				  <tr><td height="5" style="font-size:5px; line-height: 5px;"> </td></tr>'+
...
'					Agenda tu cita para acceder a tu paquete de tratamientos'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7104', body_mail); // Disparo mailing 450D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'¿Hace cuánto renovaste tu imagen por última vez?', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 450D to: ', correo);
                      }
                    }
                    count++;
                });
