...
// var body_mail = Procedimiento10_MX2020.html
...
'<title>Cuida tu piel y tu cabello</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
''+
'<!-- ======= ENVÍO AL SALIR DE LA CITA DE 7 MESES O AL DÍA 211 DESPUÉS DEL PROCEDIMIENTO ======= -->'+
'<!-- ======= main section ======= -->'+
''+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=3982765&c=3559763&h=85abfbb33ea45a9ff49c&fcts=20191127095851&whence=" style="display: block;" width="100%" border="0" alt="Porque un rostro saludable va con tu nuevo cabello" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Si ya pusiste un alto a la alopecia, <br>¿por qué no decir adiós a otros signos de la edad?  </div></td>'+
'              </tr>'+
'				'+
'				<tr><td height="15" style="font-size: 15px; line-height: 15px;"></td></tr>'+
'				'+
...
'					No te quedes incompleto, en Kaloni nos preocupamos por que tú te veas y te sientas mejor. Por ello, ponemos a tu disposición nuestra gama de tratamientos personalizados para atender afecciones en la piel como: ojeras, enrojecimiento, piel grasa, pigmentación, flacidez, arrugas y otras imperfecciones. Combátelas de manera efectiva con un tratamiento personalizado.'+
'					<br><br>	'+
'					Pregunta a tu médico el tratamiento indicado para tu tipo de piel. <span style="color: #456CB3; font-family: \'Helvetica\', Calibri, sans-serif; font-weight: 800;"><a href="https://bit.ly/2oXfECI" style="color: #456CB3;border-style: none !important; border: 0 !important;text-decoration: none;">Realiza tu test en línea</a></span>'+
'					</td>'+
'                  </tr>'+
...
'                  </tr>'+
'					'+
'				<table border="0" width="480" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">'+
...
'					NO OLVIDES AGENDAR TU CITA DE REVISIÓN DE 8 MESES'+
...
'</html>';
            ...
            var result = get_saved_search('customsearch7095', body_mail); // Disparo mailing 211D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'Cuida tu piel y tu cabello', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 211D to: ', correo);
                      }
                    }
                    count++;
                });
