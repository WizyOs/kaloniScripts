function portletNamesp(request, response){
   
	var water = "https://system.na2.netsuite.com/core/media/media.nl?id=1177377&c=3559763&h=2d4ee1c9bc796bacabe0";
...
idProsc=record.getFieldValue('custentity227');
 ...
 //-----------------------------------------------INICIO MUESTRA PRP------------------------------------
  ...
  if(firma_cli!=null){
    ...
    var firma_cli="<img height=\"60px\" width=\"120px\" src=\""+firma_cli+"\"/>";
  }else{firma_cli="";}
            var firma_med= record2.getFieldValue('custevent87');
 if(firma_med!=null){

    var firma_med="<img height=\"60px\" width=\"120px\" src=\""+firma_med+"\"/>";
  }else{firma_med="";}
 ...
 var file_firma= record.getFieldValue('custentity187');
  ...
  var firma="<img height=\"60px\" width=\"120px\" src=\""+file_firma+"\"/>";
  }else{firma="";}
  ...
  //var urlImage= fileImage.getURL();
    var firma2="<img height=\"60px\" width=\"120px\" src=\""+firma_doc_assig+"\"/>";
  }else{firma2="";}
 ...
 // var fileImage = nlapiLoadFile(firma_doc_Injert);
  //var urlImage= fileImage.getURL();
    var firma3="<img height=\"60px\" width=\"120px\" src=\""+firma_client_Injert+"\"/>";
  }else{firma3="";}
 ...
 // var fileImage = nlapiLoadFile(firma_doc_Injert);
  //var urlImage= fileImage.getURL();
    var firma4="<img height=\"60px\" width=\"120px\" src=\""+firma_doc_Injert+"\"/>";
  }else{firma4="";}
  ...
  var urlImage= fileImage.getURL();
    var firma4="<img height=\"60px\" width=\"120px\" src=\""+nlapiEscapeXML(urlImage)+"\"/>";
  }else{firma4="";
  ...
  var urlImage= fileImage.getURL();
    var firma5="<img height=\"60px\" width=\"120px\" src=\""+nlapiEscapeXML(urlImage)+"\"/>";
  }else{firma5="";}
...
var  strName0="<div style=\"font-size:10pt\">";
  ...
  strName0 += "<td width=\"275\"  style=\"font-family:'Aria', sans-serif\"><b>TELEFÓNO: &nbsp;</b>" + checado(phone) + "</td>";
    strName0 += "</tr>";
    strName0 += "<tr>";
...
strName0 += "<br/>";
  ...
  strName0 += "<td width=\"255\">¿Qué tipo de cicatrización tiene?&nbsp;<b>"+ checado(type_c) +"</b></td>";
    strName0 += "<td width=\"20\"></td>";
  strName0 += "<td width=\"255\">¿Cual?<b>&nbsp;"+ checado(Medic) + "</b></td>";
     strName0 +="</tr>";
     strName0 +="<tr><td >"+ checado(alcoholismo) +"</td><td colspan=\"4\">¿Íngiere con frecuencia alcohol?</td></tr>";
 ...
 strName0 += "<td width=\"300\" style=\"font-family:'Aria', sans-serif\" align=\"center\"><u> "+ checado(name)+"</u></td>";
   strName0 += "<td width=\"300\" style=\"font-family:'Aria', sans-serif\" align=\"center\"><u> "+ checado(medic_valoration)+"</u></td>";
  strName0 += "</tr>";
  strName0 += "<tr>";
  ...
  strName0 += "<pbr/>";
  strName0 += "<br/>"; 
    strName0+="<table width=\"100%\"><tr><td width=\"33%\"></td><td width=\"34%\" style=\"font-family:'Aria', sans-serif\" color=\"#FFFFFF\" background-color=\"#346094\" align=\"center\">FOR MATO DE VALORACIÓN</td><td width=\"33%\"></td></tr></table>";
  strName0 +="<div style=\"font-size:10pt\">";
  ...
  strName0 +="</tr>";
  strName0 +="<tr>";
  strName0 +="<td width=\"33%\" align=\"center\">" + img_val_1 + "</td>";
  strName0 +="<td width=\"33%\" align=\"center\" valign=\"middle\"></td>";
  strName0 +="<td width=\"33%\" align=\"center\">" + img_val_2 + "</td>";
  strName0 +="</tr>";
  strName0 +="<tr>";
  strName0 +="<td>";
  strName0 +="<br/>";
  ...
  strName0 +="<table width=\"100%\" style=\"font-family:'Aria', sans-serif;\" font-size=\"10pt\" >";
  strName0 +="<tr>";
  strName0 +="<td width=\"77%\"  align=\"center\">" + img_val_3 + "</td>";
  strName0 +="<td width=\"32%\" align=\"center\" valign=\"middle\"></td>";
  strName0 +="<td width=\"77%\"  align=\"center\">" + img_val_4 + "</td>";
  strName0 +="</tr>";
  strName0 +="<tr>";
  ...
  strName +="<tr>";
  strName += "<td style=\"align:center\" font-size=\"10pt\"><b>PROTECCIÓN DE DATOS DE CARÁCTER PERSONAL</b></td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  strName +="<br/>";
  ...
  strName +="</tr>";
  strName +="<tr>";
  strName += "<td style=\"align:left\"><b>D./D. "+ checado(name)+" ,mayor  de  edad,     con</b></td>";
  strName +="</tr>";
  strName +="<tr>";
  strName += "<td style=\"align:left\"><b>D.N.I. "+ checado(IdIdentifi)+" ,en mi calidad personal o como representante  legal   del/la menor de edad:"+ checado(age)+",</b></td>";
  strName +="</tr>";

  strName +="<tr>";
  strName += "<td style=\"align:center\">En cumplimiento de lo establecido en la Ley Orgánica 15/1999, de 13 de Diciembre, sobre Protección de Datos de Carácter Personal, DECLARO haber sido informado/a que mis datos personales o los del menor que represento, serán tratados y quedarán incorporados en los ficheros de los que es titular KALONI HAIR, s.L.U. con C. 1.F.: B-87595708, con la finalidad de facilitar la prestación de los servicios sanitarios solicitados y la esti6n administrativa y de facturación derivada de los mismos. A su vez quedo informado/a de que las imágenes obtenidas con las cámaras de videovigilancia serán únicamente destinadas a la finalidad de seguridad y vigilancia de las Instalaciones.</td>";
 strName +="</tr>";

 strName +="<tr>";
 strName += "<td style=\"align:center\">Las respuestas a las cuestiones planteadas tienen carácter obligatorio, en caso de no suministrar los datos requeridos, no será posible la prestación del servicio solicitado. Como titular de los datos me comprometo a comunicar a KALONI HAIR, S.L.U. cualquier modificación que se produzca en los datos aportados de forma que se mantengan siempre exactos y puestos al dia.</td>";
 strName +="</tr>";

strName +="<tr>";
strName += "<td style=\"align:center\">Asimismo, he sido informado/a que puedo ejercer los derechos de acceso, rectificación cancelación V oposición mediante escrito, acompañado de copia de documento oficial que me identifique, dirigido a KALONI HAIR, S.L.U.,en Paseo Chopera, 188 Local 28100 Alcobendas (Madrid).</td>";
strName +="</tr>";

strName +="<tr>";
strName += "<td style=\"align:center\">Los datos proporcionados son confidenciales y no serán cedidos a terceros salvo en los casos en que se cuente con mi autorización expresa, o en aquellos casos que estén previstos por la legislación vigente. Del mismo modo, doy mi autorización a KALONI HAIR, S.L.U.,para que pueda remitirme por correo ordinario o cualquier otro medio (teléfono/mall/sms) recordatorios de citas o revisiones periódicas y felicitaciones navideñas, así como información comercial sobre sus diferentes productos, servicios, ofertas y descuentos.</td>";
strName +="</tr>";

  strName +="<tr>";
  strName += "<td style=\"align:left\">Marque la casilla si no desea recibir:</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName += "<td style=\"align:left\">";
  strName +="<ul>";
  strName +="<li>Recordatorios de Citas</li>";  
  strName +="<li>Felicitaciones  Navideñas</li>";
  strName +="<li>Información comercial</li>";
  strName +="</ul>";
  strName +="</td></tr>";
  
  strName +="<tr>";
  strName += "<td style=\"align:center\">Con la firma del presente escrito dejo constancia de haber sido Informado/a previamente, y CONSIENTO de forma expresa a KALONI HAIR, S.L.U., a que datos personales relacionados con mi tratamiento clínico, como puedan ser fotograflas ,puedan ser compertidos con otros profesionales , expuestos como caso de estudio cllnico con congresos o en cursos profesionales con fines docentes, en publicaciones científicas como instrumentos de divulgación médica o en la página web de la consulta así como para fines publicitarios</td>";
  strName +="</tr>";

  strName +="<tr>";
  strName += "<td style=\"align:center\">Marque la casilla si no consiente la utilización de fotografías en:</td>";
  strName +="</tr>";
  ...
  strName += "<td style=\"align:left\">";
   strName +="<ul>";
   strName +="<li>Congresos/cursos</li>";
   strName +="<li>Publicaciones científicas</li>";
   strName +="<li>Fines publicitarios</li>";
   strName +="</ul>";
  strName +="</td></tr>";
  strName +="<tr>";
  strName += "<td style=\"align:center\">Excepciones___________________________</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName += "<td style=\"align:center\">Finalmente he sido informado/a de que mis datos personales, Incluidos los de salud, serán cedidos a las entidades aseguradoras con las que mantenga concertados seguros de asistencia médica con el fin de facilitar el gasto sanitario</td>";
  strName +="</tr>";
  
  
strName +="<tr>";
strName += "<td style=\"align:center\">En "+ checado(date) +"</td>";
strName +="</tr>";
strName +="<tr>";
strName += "<td style=\"align:center\">Fdo______________________________________________________</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName += "<td style=\"align:center\">En caso de menores, firma del representante legal</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName += "<td style=\"align:center\"><b>CONSENTIMIENTO INFORMADO INFORMADO  PARA EL MICROINJERTO CAPILAR</b></td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  strName +="<br/>";
  ...
  strName +="</tr>";
  strName +="<tr>";
  strName += "<td style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\" align=\"left\"><b>INSTRUCCIONES</b>.</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  strName +="<br/>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Este es un documento de consentimiento informado que ha sido preparado para ayudar a su médico a informarle sobre el microinjerto capilar, sus riesgos y los tratamientos alternativos, tal como establece la Ley 41/2002, de 14 de noviembre, básica reguladora de la autonomía del paciente y de derechos y obligaciones en materia de información y documentación clínica publicada en el BOE del 15-11-02 - no 274,aptdo. 2 del artículo 8.</p>";
  strName +="</td>";
  strName +="</tr>";
   ...
   strName +="<td>";
   strName +="<br/>";
   strName +="<p>Es importante que lea esta información de forma cuidadosa y completa. Por favor, ponga sus iniciales en cada página, indicando así que ha leído la página, y firme el consentimiento para el procedimiento propuesto.</p>";
    strName +="<br/>";
    strName +="</td>";
   strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">INTRODUCCIÓN</p>";
  strName +="</td>";
  strName +="</tr>";
  
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">El microinjerto capilar es un procedimiento para mejorar los signos visibles de la alopecia o calvicie. El microinjerto capilar no puede detener el proceso de pérdida y caída de cabello o vello pero puede mejorar los signos más visibles mediante el aumento de densidad del cabello en las zonas donde éste se va perdiendo.</p>";
  strName +="</td>";
  strName +="</tr>";
  
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">El microinjerto capilar se individualiza para cada paciente. Cuanta más densidad de cabello queramos, si el proceso de caída de cabetlo o vetlo continúa y si el área a cubrir es muy grande, se requerirá mayor número de sesiones.</p>";
  strName +="</td>";
  strName +="</tr>";

 strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">TRATAMIENTO ALTERNATIVO.</p>";
  strName +="</td>";
  strName +="</tr>";

   strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Las formas  alternativas de tratamiento de la alopecia consisten actualmente, en el uso de lociones capilares tópicas de minoxtdil al 2% o al 5% o, en hombres, el finasteride (lmgr. vía oral). Existen otros tratamientos quirúrgicos con mayores riesgos y complicaciones potenciales asociados.</p>";
  strName +="</td>";
  strName +="</tr>";
  
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">RIESGOS DEL MICROINJERTO CAPllAR</p>";
  strName +="</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Cualquier procedimiento médico entraña un cierto grado de riesgo comprenda los riesgos asociados del microinjerto capilar.La decisión individual de someterse al tratamiento se basa en la comparación del riesgo con el beneficio potencial.</p>";
  strName +="</td>";
  strName +="</tr>";
    
   strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Aunque la mavoria de los pacientes no experimentan las siguientes complicaciones, usted debera asegurarse de que comprende los riesgos y complicaciones del procedimiento.</p>";
  strName +="</td>";
  strName +="</tr>";
    
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Sangrado es posible, aunque muy raro, que se presente un episodio de hemorragia durante o despúes del procedimiento. No debe tomar aspirina o antiinflamatorios desde 10 días antes de la cirugía, puesto que pueden aumentar el riesgo de problemas de sangrado.La hipertensión(aumento de la presión sanguínea) que no está bien controlada médicamente puede ser causa de sangrado durante o despúes del procedimiento. Los acumulos de la sangre pueden retrasar la curación y causar cicatrización excesiva</p>";
  strName +="</td>";
  strName +="</tr>";
    strName +="</table>";
  ...
  strName +="<table  width=\"100%\" style=\"font-family:'Aria', sans-serif;\" >";
   strName +="<tr>";
   strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Infección.</b>"+ " La infección después del procedimiento es muy rara. Si ocurre una infección, puede ser necesario tratamiento adicional, incluyendo antibióticos.</p>";
  strName +="</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
 ...
 // strName +="</table>";
  ...
  strName +="<tr>";
   strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Foliculitis</b>."+ "Cuando el cabello inicia su crecimiento (aproximadamente hacia los tres meses tras la intervención) pueden aparecer puntos de foliculitis (inflamación) al romper la piel el cabello que está creciendo. Es importante seguir la pauta de controles postoperatorios para controlar las posibles foliculitis. En personas que tienen tendencia a formar queloides, puede presentar una foliculitis queloidea.</p>";
  strName +="</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Asimetría.</b>"+ " La cara humana es normalmente asimétrica. Puede haber variación entre un lado y otro en el resultado de un microinjerto capilar.</p>";
  strName +="</td>";   
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Anestesia.</b>"+" La anestesia local implica un riesgo al igual de su aplicación en el campo de la odontología y en algunos procedimientos médicos.</p>";
  strName +="</td>";   
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Resultadoinsatisfactorio.</b>"+ "Existe la posibilidad de un resultado insatisfactorio. Usted puede estar insatisfecho con los resultados del procedimiento. lnfrecuentemente se necesita realizar microinjerto adicional para mejorar los resultados. Es importante saber que el microinjerto capilar no detiene el proceso de caída del cabello. Depende del resultado final que desee conseguir precisará más sesiones de microinjerto. El número de cabellos que se injertan depende,entre otros factores del área a cubrir, del espesor de cabello de la zona donante y de las características del mismo (rubio,moreno,erueso, fino,Liso, rizado...)</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="</tr>";
   ...
   strName +="<tr>";
   strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Reacciones alérgicas.</b>"+ "En casos raros se han descrito alergias locales al esparadrapo, material o preparados tópicos. Pueden ocurrir reacciones sistémicas, que son más graves, frente a medicaciones usadas durante el procedimiento o prescritas después. Las reacciones alérgicas pueden requerir tratamiento adicional.</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Pérdida de pelo.</b>"+" Puede ocurrir pérdida del pelo tanto alrededor de la zona donante como en el área receptora del cabello pasados unos días del procedimiento. Esta pérdida se recupera al cabo de unos tres meses y el cabello sigue con sus ciclos normales de crecimiento y caída. Las reacciones alérgicas pueden requerir tratamiento adicional.</p>";
  strName +="</td>";
  strName +="</tr>";
 ...
 strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Retraso en la cicatrización.</b>"+" Los fumadores tienen un mayor riesgo de complicaciones de la cicatrización.</p>";
  strName +="</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>Efecto a largo plazo.</b>"+" El microinjerto capilar no detiene el proceso de caída de cabello o vello. Puede necesitarse en un futuro otro procedimiento u otros tratamientos para mantener los resultados.</p>";
  strName +="</td>";
  strName +="</tr>";
...
strName +="</table>";
  ...
  strName +="<table  width=\"100%\" style=\"font-family:'Aria', sans-serif;\" >";
   strName +="<tr>";
   strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>NECESIDAD DE UN PROCEDIMIENTO ADICIONAL.</b></p>";
  strName +="</td>";   
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
 ...
 // strName +="</table>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Una única sesión de microinjerto suele ser insuficiente para conseguir el resultado deseado . Debe tener claro que el avance de la alopecia puede hacer necesario realizar nuevas sesiones de microinjerto para ir sustituyendo el cabello que se pierde en el proceso de avance de su cal'.licie. La práctica de la Medicina no es una ciencia exacta, y aunque se esperan buenos resultados, no hay garantía explicita o implícita sobre los resultados que pueden obtenerse.</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>RENUNCIA</b>.</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Los documentos  de consentimiento  informado se emplean  para  comunicar  información  acerca del tratamiento médico propuesto para una enfermedad o condición determinada, así como para mostrar los riesgos y formas alternativas de tratamiento. El proceso de consentimiento informado pretende definir los principios para dar a conocer los  riesgos, que generalmente satisfará las necesidades de la mayoría de los pacientes en la mayoría de las circunstancias.</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Sin embargo, no debe considerarse que los documentos de consentimiento informado incluyan todos los aspectos sobre otros métodos o riesgos posibles. Su médico puede proporcionarle información adicional  o  diferente, basada en todos los hechos de su caso particular y en el estado del conocimiento médico.</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">ES IMPORTANTE QUE LEA CUIDADOSAMENTE LA INFORMACIÓN ANTERIOR Y HAYAN SIDO RESPONDIDAS TODAS SUS PREGUNTAS ANTES DE QUE FIRME ESTE CONSENTIMIENTO</p>";
  strName +="</td>";
  strName +="</tr>";
 ...
 strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\"><b>CONSENTIMIENTO PARA EL PROCEDIMIENTO</b></p>";
  strName +="</td>";
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">1. Por la presente autorizo al equipo médico de KALONI y a los ayudantes que sean seleccionados para realizar el siguiente procedimiento: "+ checado(medic_valoration) +" He recibido el siguiente folleto informativo:</p>";
  strName +="</td>";
  strName +="</tr>";
  
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Consentimiento informado para microinjerto capilar</p>";
  strName +="</td>";
  strName +="</tr>";
  ...
  strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">3. Doy consentimiento para el fotografiado de el o los procedimiento(s) que se van a realizar, con fines médicos puesto que mi identidad no será revelada en lás imágenes.</p>";
  strName +="</td>";
  strName +="</tr>";
  
 strName +="<tr>";
  strName +="<td>";
  strName +="<p style=\"font-family:'Aria', sans-serif\" font-size=\"11pt\">Me ha sido explicado de forma comprensible el procedimiento a realizar.</p>";
  strName +="</td>";
  strName +="</tr>";
...
if(record2!=null){
  ...
  strName +="</tr>";
  strName +="<tr>";
  strName +="<td width=\"50%\" align=\"center\">Foto despúes del injerto" + imgtry + "</td>";
  strName +="<td width=\"30%\" align=\"center\" valign=\"middle\"></td>";
...
//NOTA POS-PROCEDIMIENTO
 ...
 strName += "<tr><td style=\"font-family:'Aria', sans-serif\" font-size=\"10pt\"><b>TERMINO DE EXTRACCIÓN: &nbsp;</b>" +  checado(TER_EXTR) + "</td></tr>";
  ...
  strName += "</tr>";
  strName += "<tr>";
  strName += "<td width=\"275\"  style=\"font-family:'Aria', sans-serif\"><b>EQUIPO MEDICO ENFERMERIA: &nbsp;</b></td>";
  strName += "</tr>";
  strName += "</table>";
 strName += "</div>";
  }
...
var folderPath = parentP.getSelectOptions("EXP_ESPAÑA");
...
var myPDFfileID = nlapiSubmitFile(root);
  ...
  var FOLD24H = nlapiCreateRecord('folder');
    ...
    folderPath.setFieldValue('name','EXP_ESPAÑA');
