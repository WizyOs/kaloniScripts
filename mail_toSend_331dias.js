...
// var body_mail = Procedimiento14_MX2020.html
...
'<title>¡Felicidades! Tu primer aniversario con cabello</title>'+
'<style type="text/css">'+
'body {'+
'    width: 100%;'+
...
'                <tr>'+
'                  <td align="center" style="color: #ffffff; font-size: 14px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 24px;"><div style=" line-height: 24px;"> <a href="https://3559763.app.netsuite.com/core/media/media.nl?id=4301435&c=3559763&h=f5c8df2133be38e6e3e7&mv=k3ytbtbs&_xt=.html&fcts=20191209111219&whence=" style="color: #ffffff; text-decoration: none;">¿Problemas con las imágenes? Ver en línea</a> </div></td>'+
'                </tr>'+
'              </table></td>'+
'          </tr>'+
'        </table></td>'+
...
'						  '+
'                          <tr>'+
'                            <td align="center" class="section800_img"><a href="#" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=4301390&c=3559763&h=57504a0d8c465803ec95&fcts=20191209111029&whence=" style="display: block;" width="100%" border="0" alt="HAY COSAS QUE MERECEN CELEBRARSE. TU PRIMER AÑO CON CABELLO ES UNA DE ELLAS!" /></a></td>'+
'                          </tr>'+
'						 '+
...
'              <tr>'+
'                <td align="left" style="color: #456cb3; font-size: 36px; font-family: \'Poppins\', Calibri, sans-serif; font-weight: 700;" class="main-section-header text-space"><div style="line-height: 40px; text-transform: uppercase;"> Cuando menos te das cuenta, ya ha pasado casi un año desde tu procedimiento. </div></td>'+
'              </tr>'+
'				'+
...
'				  '+
'				 Cuéntanos ¿cuál ha sido tu experiencia en este tiempo y de qué manera vas a celebrar esta decisión que tomaste?'+
'				  '+
'				  </div></td></tr>'+
'				'+
...
'					En Kaloni queremos agradecer tu preferencia y nos unimos a tu celebración.'+
'					<br><br>'+
'					Por ello, en tu próxima cita de revisión de 12 meses te haremos entrega de un regalo especial.'+
'					</td>'+
'                  </tr>'+
...
'		<tr>'+
'			<td align="center">'+
'				<table border="0" align="center" width="490" cellpadding="0" cellspacing="0" class="container590">'+
'					'+
'					<tr>'+
'						<td>	'+
...
'										<a href="" style=" border-style: none !important; border: 0 !important;"><img src="https://3559763.app.netsuite.com/core/media/media.nl?id=4301391&c=3559763&h=5c28b863a8af5b840109&fcts=20191209111033&whence=" style="display: block; max-width: 160px;" width="160" border="0" alt=""/></a>'+
'									</td>'+
'								</tr>'+
'							</table>'+
'																				'+
...
'								<tr><td width="5" height="20" style="font-size: 20px; line-height: 20px;"> </td></tr>'+
'							</table>'+
'							'+
...
'								'+
'								<tr class="hide"><td height="20" style="font-size: 20px; line-height: 2Opx;"> </td></tr>'+
'								'+
'								<tr>'+
'									<td align="left" style="color: #456cb3; font-size: 22px; font-family: Montserrat, Calibri, sans-serif; font-weight: 700; line-height: 26px;" class="align-center main-header">'+
'										<!-- ======= section text ====== -->'+
'										'+
'										<div style="line-height: 32px">'+
'				        					'+
'				        						Obtén una Vitamina Kaloni*'+
'				        					'+
'										</div>'+
'			        				</td>	'+
'								</tr>'+
'								'+
'								<tr><td height="10" style="font-size: 10px; line-height: 1Opx;"> </td></tr>'+
'								'+
'								<tr>'+
'									<td align="left" style="color: #333333; font-size: 16px; font-family: \'Hind Siliguri\', Calibri, sans-serif; line-height: 24px;" class="align-center">'+
'										<!-- ======= section text ====== -->'+
'										<div style="line-height: 24px">'+
'				        					'+
'				        						Este aporte multivitamínico ayuda a generar los nutrientes necesarios en el organismo para mantener una piel saludable y fortalecer tu cabello.'+
'				        					'+
'										</div>'+
'			        				</td>	'+
'								</tr>'+
...
'		'+
'	</table>'+
'	     <!-- Final de Regalo de Vitamina Kaloni -->'+
'			  '+
...
'                  </tr>'+
'					'+
'				<table border="0" width="220" align="center" cellpadding="0" cellspacing="0" class="container590" bgcolor="#456CB3">'+
'				  <tr><td height="10" style="font-size:10px; line-height: 10px;"> </td></tr>'+
'                  <tr><td height="10" style="font-size:10px; line-height: 10px;"> </td>'+
'                    <td height="25" style="color: #fff; font-size: 15px; font-family: \'Helvetica\', Calibri, sans-serif; line-height: 22px;text-align: center;font-weight:800; "> '+
'					<a href="https://kaloni.mx/contacto.html" style=" border-style: none !important; display: block; border: 0 !important;text-decoration: none;color: #fff;">AGENDA TU CITA</a>'+
...
'</body>'+
'</html>';
            var result = get_saved_search('customsearch7100', body_mail); // Disparo mailing 331D
                ...
                myPage.data.forEach(function(result){
					...
					if(correo != "" && correo != null)
                    {
                      ...
                      if(noVolverAcontactar == false)
                      {
                        ...
                        email.send({author: 198528, recipients:correo, subject:'¡Felicidades! Tu primer aniversario con cabello', body:body_m}); // 103204 198528 , cc: ccRecip
                        log.debug('Disparo mailing 331D to: ', correo);
                      }
                    }
                    count++;
                });
